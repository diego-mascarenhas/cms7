<style type="text/css">
	* {
	...
	.section-title.section-title-full {
		font-size: 26px;
		font-family: 'proxima-sb';
		border-bottom: 3px solid #FF1A1D;
								...
								<td style="padding-left: 10px;">
									<p class="tw-semibold tc-red-5">REVISION ALPHA S.A.S.<br>
										<span class="tw-regular" style="color:#808080;">Vuelta de Obligado 2443 Of. 403,
											CABA<br>
											+54.11 5274.8490<br>
											I.V.A. Responsable Inscripto</span>
									</p>
								</td>
								<td>&nbsp;</td>
								<td>
									<p><strong>Fecha:</strong> <?php echo $_POST['fecha']; ?><br>
										...
										<strong>Inicio de Actividad:</strong> 10/12/2019
									</p>
								</td>
							</tr>
							<tr>
					...
					<table cellspacing="0" class="table-detalle">
						...
						<tbody>
							...
							{ ?>
								<tr>
									<td align="left">
										<div style="width:520px;"><?php echo $item->descripcion; ?></div>
									</td>
					...
					<table cellspacing="0" class="table-detalle">
						<tbody>
							...
							{ ?>
								<tr>
									<td>
										<div style="width:756px; line-height:1.2;"><small class="text-xs tw-light"><em>El
													...
													Pequeños Contribuyentes de la Ley Nº 27.618.</em></small></div>
									</td>
								</tr>
							<?php } ?>
						</tbody>
											...
											<tr>
												...
												<td style="width:112px;" align="right">
													<p>$<?php echo number_format($_POST['bruto'], 2, ',', '.'); ?><br>
														...
														<span
															class="tw-semibold tc-red-5">$<?php echo number_format($_POST['total_neto'], 2, ',', '.'); ?></span>
													</p>
												</td>
											</tr>
										</tbody>
