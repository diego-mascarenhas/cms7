                ...
                <div class="col-lg-10">
                    <ul class="sortable-list connectList agile-list" id="media">
		                <?php foreach($listado as $lista) { ?>	
                       	 <li class="lista" id="<?php echo $lista['id']; ?>"> <?php echo '- '.$lista['titulo'].', vencimiento: '.$lista['fecha_vencimiento']; ?></li>
		                <?php } ?>	
                    </ul>
                </div>	
                <div class="col-lg-1"></div>
...
<script>
    $(document).ready(function(){
        ...
        update: function( event, ui ) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo base_url('encuestas/ordenarEventos/media'); ?>',
