            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Listado de Respuestas a pregunta <?php echo $pregunta;?></h5>
                    </div>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
		                   ...
		                   <?php if($listado){ foreach($listado as $lista) { ?>	
		                        ...
		                        <td><?php echo $lista['id_respuesta'];?></td>
		                    </tr>
		                   <?php } } ?>	
...
$(document).ready(function(){
    $('.dataTables-example').DataTable({
        ...
        responsive: true,
	        ...
	        buttons: [
	        	{extend: 'csv', title: 'Listado de Resultados CSV'},
	            {extend: 'excel', title: 'Listado de Resultados EXCEL'},
	            {extend: 'pdf', title: 'Listado de Resultados PDF'}
	    ]
    });
});
</script>
