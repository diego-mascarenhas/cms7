			...
			<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-xs-8 col-sm-8 col-md-6 col-lg-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><strong>Hosting</strong></li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row">
	                <div class="col-lg-12 text-center">
		                <div class="ibox-content">
		                    ...
		                    <h2 style="margin-top:20px; float:none; font-size:26px; color:#EE3F3F; font-weight:lighter;">Decinos cuál WEB tiene problemas</h2>
		                    <small>Si hay problemas con más de un sitio web tuyo,<strong> tenés que hacer de a un reclamo a la vez</strong></small>
