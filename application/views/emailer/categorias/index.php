			...
			<div class="row wrapper border-bottom white-bg page-heading">
	            ...
	            <div class="col-xs-4 col-sm-4 col-md-6 col-lg-6">
                    <div class="title-action">
                        <a href="<?php echo base_url('emailer/categorias/ingresar/'); ?>" class="btn btn-primary btn-sm">Ingresar categoría</a>
                    </div>
                </div>
	        </div>				
	                            ...
	                            <div class="table-responsive">
	                                <table class="table table-striped footable">
	                                    ...
	                                    <tbody>
		                                    ...
		                                    <tr>
			                                    <td>
				                                    <a href="<?php echo base_url('emailer/categorias/detalle/'); ?><?php echo $item['id']; ?>"><?php echo $item['categoria']; ?></a>
				                                </td>
