		            ...
		            <div class="col-lg-12">
		                <div class="ibox float-e-margins">
		                    <div class="ibox-title">
		                        <h5><?php echo (empty($detalle['id'])) ? 'Crear nueva plantilla' : 'Modificar plantilla'; ?></h5>
		                    </div>
		                    <div class="ibox-content">
	                            ...
	                            <?php echo form_open(null, array('class'=>'form-horizontal')); ?>
	                            	...
	                            	<div class="form-group">
		                                ...
		                                <div class="col-sm-4">
			                                <input type="text" name="template" class="form-control" value="<?php echo (isset($detalle['template'])) ? $detalle['template'] : null; ?>">
			                            </div>
		                            </div>
		                            ...
		                            <div class="form-group">
		                                ...
		                                <div class="col-sm-10">
			                                <?php echo form_textarea('codigo', (isset($detalle['codigo'])) ? $detalle['codigo'] : null, 'class="form-control ckeditor col-sm-12"'); ?>
			                            </div>
		                            </div>
		                            <div class="hr-line-dashed"></div>
