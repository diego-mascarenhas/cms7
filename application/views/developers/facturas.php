	                ...
	                <div class="col-lg-12">
	                    <div class="ibox ">
	                        <div class="ibox-title">
	                            <h5>Obtención de Facturas</h5>
	                        </div>
	                        <div class="ibox-content">
	                            <p class="m-b-lg">Se pueden utilizar filtros como search, estado, order_by, order, page y per_page. <em>ej: /?page=2&per_page=5</em></p>

<textarea class="code">

	require 'sdk.cms.php';
	
	$request = new CMS('facturas');
	            ...
	            <div class="row">
	                <div class="col-lg-12">
	                    <div class="ibox ">
	                        ...
	                        <div class="ibox-content">
	                            <p  class="m-b-lg">Obtención del detalle completo de la Factura.</p>

<textarea class="code">

	require 'sdk.cms.php';
	
	$request = new CMS('factura/ID');
