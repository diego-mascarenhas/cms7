			...
			<div class="row wrapper border-bottom white-bg page-heading">
	            <div class="col-xs-8 col-sm-8 col-md-6 col-lg-6">
	                ...
	                <ol class="breadcrumb">
	                    ...
	                    <li class="active">
	                        <strong>Categorías generales</strong>
	                    </li>
	                </ol>
	            </div>
	                ...
	                <div class="col-lg-12">
	                    <div class="ibox ">
	                        <div class="ibox-title">
	                            <h5>Obtención de Categorías</h5>
	                        </div>
	                        <div class="ibox-content">
	                            <p class="m-b-lg">Se pueden utilizar filtros como search, estado, order_by, order, page y per_page. <em>ej: /?order_by=categoria&order=DESC</em></p>

<textarea class="code">

	require 'sdk.cms.php';
	
	$request = new CMS('categorias-generales');
	            ...
	            <div class="row">
	                <div class="col-lg-12">
	                    <div class="ibox ">
	                        ...
	                        <div class="ibox-content">
	                            <p  class="m-b-lg">Obtención del detalle completo de las categorías.</p>

<textarea class="code">

	require 'sdk.cms.php';
	
	$request = new CMS('categorias-generales/302');
