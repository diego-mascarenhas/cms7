	            ...
	            <ul class="nav metismenu" id="side-menu">
	                <li class="nav-header">
	                    <div class="dropdown profile-element"> 
		                    <?php if (file_exists(FCPATH . 'multimedia/' . $this->usuario->grupo . '/logo.png')) echo '<span><a href="' . $this->usuario->dashboard . '"><img width="170px" src="' . base_url('multimedia/' . $this->usuario->grupo . '/logo.png') . '" /></a></span>'; ?>
...
<!--
                    ...
                    <li<?php if($this->uri->segment(1) == 'cms-v2') { echo ' class="active"';}?>>
	                    ...
	                    <ul class="nav nav-second-level">
		                    ...
		                    <li>
			                    <a><i class="fa fa-book"></i> <span class="nav-label">E-commerce</span><span class="fa arrow"></span> </a>
