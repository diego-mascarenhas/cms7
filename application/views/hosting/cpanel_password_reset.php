			...
			<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-xs-8 col-sm-8 col-md-6 col-lg-6">
	                ...
	                <ol class="breadcrumb">
	                    ...
	                    <li class="active">
	                        <strong>Cambiar contraseña de cPanel</strong>
	                    </li>
	                </ol>
                </div>
            </div>
			...
			<div class="wrapper wrapper-content">
                <div class="middle-box text-center animated fadeInRightBig">
					...
					<?php if (isset($detalle['password'])) { ?>
						<h3 class="font-bold">Cambiar contraseña de cPanel</h3>
	                    <div class="error-desc">
	                        <p>La nueva contraseña para el dominio <?php echo $detalle['domain']; ?> es <strong><?php echo $detalle['password']; ?></strong></p>
					...
					<?php } else { ?>
		                <?php echo form_open(null, array('class'=>'form-horizontal')); ?>
		                    ...
		                    <h3 class="font-bold">Cambiar contraseña de cPanel</h3>
		                    <div class="error-desc">
		                        <p>¿Estás seguro que quieres cambiar la contraseña del dominio <strong><?php echo $detalle['domain']; ?></strong>?</p>
