	                            ...
	                            <div class="panel-body">
								 <div class="row">
					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Encabezado</h2>
					                 	<div class="form-group">
											<label class="col-sm-1 control-label m-t-sm">Título</label>
											<div class="col-sm-5">
					                ...
					                <?php 
					                    ...
					                    <div class="col-sm-12 p-xxs m-t-sm">
						                    <div class="pull-left full-width">
							                	...
							                	<a title="Ingresar" id="item" href="#" data-toggle="modal" data-id="<?php echo $categoria['id']; ?>" data-seccion="<?php echo $categoria['id']; ?>"data-id_contenido="<?php echo $detalle['id'];?>" data-idioma="<?php echo $idioma['extension'];?>" data-target="#myModalFaqs" class="sepV_a btn btn-primary btn-sm red pull-right"><i class="fa fa-plus-circle"></i> Ingresar</a></h3>
	    ...
	    <div class="modal-dialog modal-lg">
	   		<div class="modal-content animated">
		        <div class="modal-header">
		            ...
		            <h4 class="modal-title">Ingresar contenido de<br>Listado de Casos</h4>
		        </div>
