...
.box-items { padding-left:5px; padding-right:5px;}
       ...
       <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox-title ibox-title-custom"><h5>Subir contenido para <a><?php echo str_replace('<br>',' ',$detalle['seccion']); ?></a></h5></div>
                </div>
								 ...
								 <div class="row">
					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Contenido</h2>
					                 	...
					                 	<div class="form-group m-b-md pull-left full-width m-t-md">
						                    <label class="col-sm-2 control-label">Texto <button type="button" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" data-placement="top" data-original-title="Texto."> <i class="fa fa-question"></i></button></label>
						                    <div class="col-sm-10"><textarea class="form-control summernote2" name="contenido1_<?php echo $idioma['extension'];?>" rows="3"><?php echo(isset($item['contenido1'])) ? $item['contenido1']: null?></textarea></div>
