...
@media (min-width:992px) {
	.modal-lg {width:800px;}
       ...
       <div class="row wrapper border-bottom white-bg page-heading">
			...
			<input type="hidden" name="medidas" value="2500x1050" />
	                            ...
	                            <div class="panel-body">
								 <div class="row">
					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Encabezado</h2>
					                 	<div class="form-group">
							                    <label class="col-sm-1 control-label">Título <button type="button" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" data-placement="top" data-original-title="Título que se muestra sobre la imagen. Se debe copiar sin formato o redactarlo directamente, seleccionarlo cada línea y aplicar H3 (se encuentra en el botón de varita mágica). Para el subrayado: luego de aplicar H4 seleccionar el texto a subrayar y aplicar U. Máximo 150 caracteres."> <i class="fa fa-question"></i></button></label>
							                    <div class="col-sm-5"><textarea class="form-control summernote2" name="titulo_<?php echo $idioma['extension'];?>" rows="4"><?php echo (isset($item['titulo'])) ? $item['titulo']: null; ?></textarea></div>
					                ...
					                <div class="col-lg-12 p-xxs m-t-md">
			                            <div class="form-group">
						                    <label class="col-sm-1 control-label">Texto <button type="button" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" data-placement="top" data-original-title="Texto de la sección."> <i class="fa fa-question"></i></button></label>
						                    <div class="col-sm-11">
											    <textarea class="form-control summernote" name="contenido1_<?php echo $idioma['extension'];?>" rows="4"><?php echo (isset($item['contenido1'])) ? $item['contenido1']: null; ?></textarea></div>
					                    </div>
					                </div>
					                ...
					                <?php 
					                    ...
					                    <div class="col-sm-12 p-xxs">
						                    <div class="pull-left full-width">
							                	...
							                	<a title="Ingresar" id="item" href="#" data-toggle="modal" data-seccion="<?php echo $categoria['id']; ?>" data-id="<?php echo $categoria['id']; ?>" data-id_contenido="<?php echo $detalle['id'];?>" data-idioma="<?php echo $idioma['extension'];?>" data-target="#myModalFaqs" class="sepV_a btn btn-primary btn-sm red pull-right"><i class="fa fa-plus-circle"></i> Ingresar</a></h3>
	    ...
	    <div class="modal-dialog modal-lg">
	   		<div class="modal-content animated">
		        <div class="modal-header">
		            ...
		            <h4 class="modal-title">Ingresar contenido para<br>Listado de ítems</h4>
		        </div>
			        ...
			        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/ingresar_informacion/'); ?>">
	                    ...
	                    <div class="col-sm-12">
	                    	...
	                    	<div class="input-group col-sm-9">
		                        <div class="fileinput fileinput-new form-control" data-provides="fileinput"><input type="file" name="imagen"><span class="input-group-btn" style="position: absolute;right: 28px;top: 0;"><button type="button" class="btn btn-primary m-l-sm" data-toggle="tooltip" data-placement="top" data-original-title="Imagen en jpg, gif o png de 100x100 píxeles. Recuerde que el peso debe ser el mínimo posible para no afectar la descarga del site." title=""> <i class="fa fa-question"></i></button></span></div></div>
	                    </div>
	                   ...
	                   <div class="col-sm-12 m-t-md">
		                    <label class="control-label col-sm-3">Subtítulo</label>
		                    <div class="input-group col-sm-9"><input type="text" name="subtitulo" id="subtitulo" value="" class="form-control"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Subtítulo en color bordó." title=""> <i class="fa fa-question"></i></button></span></div>
		               </div>
	                    ...
	                    <div class="col-sm-12 m-t-md">
		                    ...
		                    <div class="input-group col-sm-9"><div class="ibox-content no-padding"><textarea class="form-control summernote2" name="contenido1" rows="3"></textarea></div>
		                    </div>
	                    </div>
