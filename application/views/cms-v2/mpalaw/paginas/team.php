					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Encabezado</h2>
					                 	<div class="form-group">
											...
											<div class="col-sm-5">
		                                        <div class="input-group">
													<input type="text" name="subtitulo_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['subtitulo'])) ? $item['subtitulo'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Subtítulo de la sección, deberá incluir un barra (/) como salto de línea." title=""> <i class="fa fa-question"></i></button>
												</div>
											</div>
					                    </div>
					                </div>
					                ...
					                <?php 
					                    ...
					                    <div class="col-sm-12 p-xxs">
						                    <div class="pull-left full-width">
							                	...
							                	<a title="Ingresar" id="item" href="#" data-toggle="modal" data-seccion="<?php echo $detalle['seccion']; ?>" data-id_contenido="<?php echo $detalle['id'];?>" data-idioma="<?php echo $idioma['extension'];?>" data-target="#myModalEquipo" class="sepV_a btn btn-primary btn-sm red pull-right"><i class="fa fa-plus-circle"></i> Ingresar</a></h3>
...
<!-- Modal Ingresar Informacion -->
    <div class="modal inmodal" id="myModalEquipo" tabindex="-1" role="dialog" aria-hidden="true">
	    <div class="modal-dialog modal-lg">
	   		<div class="modal-content animated">
		        <div class="modal-header">
		            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
		            <h4 class="modal-title">Ingresar Integrantes</h4>
		        </div>
		        ...
		        <div class="modal-body p-xs pull-left full-width">
			        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/ingresar_informacion/'); ?>">
		               ...
		               <input type="hidden" name="medidas" value="430x540">
		                ...
		                <input type="hidden" name="id_tipo" value="978">
	                   <div class="col-sm-6 m-t-md">
		                    <label class="control-label col-sm-3">Nombre</label>
		                    <div class="input-group col-sm-9"><input type="text" name="titulo" id="titulo" value="" class="form-control"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Nombre." title=""> <i class="fa fa-question"></i></button></span></div>
		               </div>
	
	                   <div class="col-sm-6 m-t-md">
		                    <label class="control-label col-sm-3">Cargo</label>
		                    <div class="input-group col-sm-9"><input type="text" name="subtitulo" id="subtitulo" value="" class="form-control"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Cargo." title=""> <i class="fa fa-question"></i></button></span></div>
		               </div>
	
	                   <div class="col-sm-12 m-t-md">
		                    <label class="control-label col-sm-3">Email y Teléfono</label>
		                    <div class="input-group col-sm-9"><input type="text" name="texto_adicional" id="texto_adicional" value="" class="form-control"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Email y teléfono separado por /." title=""> <i class="fa fa-question"></i></button></span></div>
		               </div>

	                    <div class="col-sm-12 m-t-md">
		                    <label class="control-label col-sm-2">Intro <button type="button" class="btn btn-primary m-l-sm btn-circle btn-sm" data-toggle="tooltip" data-placement="top" data-original-title="Texto de introducción, al lado de la imagen." title=""> <i class="fa fa-question"></i></button></label>
	                    ...
	                    <div class="col-sm-12 m-t-md">
		                    <label class="control-label col-sm-2">Texto <button type="button" class="btn btn-primary m-l-sm btn-circle btn-sm" data-toggle="tooltip" data-placement="top" data-original-title="Texto." title=""> <i class="fa fa-question"></i></button></label>
		                    <div class="input-group col-sm-10"><div class="ibox-content no-padding"><textarea class="form-control summernote2" name="contenido2" rows="3"></textarea></div>
		                    </div>
	                    </div>

	                    <div class="col-sm-12 m-t-md">
		                    <label class="control-label col-sm-2">Texto destacado<button type="button" class="btn btn-primary m-l-sm btn-circle btn-sm" data-toggle="tooltip" data-placement="top" data-original-title="Texto destacado en fondo bordó." title=""> <i class="fa fa-question"></i></button></label>
		                    <div class="input-group col-sm-10"><div class="ibox-content no-padding"><textarea class="form-control summernote2" name="contenido3" rows="3"></textarea></div>
		                    </div>
	                    </div>

	                    <div class="col-sm-12 m-t-md">
		                    <label class="control-label col-sm-2">Tabs de info detallada <button type="button" class="btn btn-primary m-l-sm btn-circle btn-sm" data-toggle="tooltip" data-placement="top" data-original-title="Tabs con Awards and Honors e info detallada." title=""> <i class="fa fa-question"></i></button></label>
		                    <div class="input-group col-sm-10"><div class="ibox-content no-padding"><textarea class="form-control summernote2" name="contenido4" rows="3"></textarea></div>
		                    </div>
	                    </div>

	                    <div class="col-sm-12 m-t-md">
		                    <label class="control-label col-sm-2">Educación <button type="button" class="btn btn-primary m-l-sm btn-circle btn-sm" data-toggle="tooltip" data-placement="top" data-original-title="Texto de educación." title=""> <i class="fa fa-question"></i></button></label>
		                    <div class="input-group col-sm-10"><div class="ibox-content no-padding"><textarea class="form-control summernote2" name="contenido5" rows="3"></textarea></div>
		                    </div>
	                    </div>

	                    <div class="col-sm-12 m-t-md">
		                    <label class="control-label col-sm-2">COURT ADMISSIONS <button type="button" class="btn btn-primary m-l-sm btn-circle btn-sm" data-toggle="tooltip" data-placement="top" data-original-title="Texto de COURT ADMISSIONS." title=""> <i class="fa fa-question"></i></button></label>
		                    <div class="input-group col-sm-10"><div class="ibox-content no-padding"><textarea class="form-control summernote2" name="contenido6" rows="3"></textarea></div>
		                    </div>
	                    </div>
	                    ...
	                    <div class="col-sm-12 m-t-md">
	                    	...
	                    	<div class="input-group col-sm-9">
		                        <div class="fileinput fileinput-new form-control" data-provides="fileinput"><input type="file" name="imagen"><span class="input-group-btn" style="position: absolute;right: 28px;top: 0;"><button type="button" class="btn btn-primary m-l-sm" data-toggle="tooltip" data-placement="top" data-original-title="Imagen en jpg, gif o png de 430x540 píxeles. Recuerde que el peso debe ser el mínimo posible para no afectar la descarga del site." title=""> <i class="fa fa-question"></i></button></span></div></div>
	                    </div>
...
$('[data-toggle="tooltip"]').tooltip(); 
  $('#myModalEquipo').on('show.bs.modal', function(e) {    
