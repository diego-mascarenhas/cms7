	                ...
	                <?php		
						...
						{							
							...
							<?php foreach($menu1 as $obj): ?>
								...
								<li>
			                    	<p<?php echo ($obj['estado'] == 1) ? ' class="bg-inactiva"' : '';?>>
			                    		<a href="<?php echo (isset($obj['url'])) ? base_url('cms-v2/paginas/modificar/'.$obj['id_contenido']) : '#'; ?>">
								<?php } ?>
				                    	<?php if (!isset($nivel)) { ?>
			                    		...
			                    		<a href="<?php echo base_url('cms-v2/paginas/modificar/'.$obj['id_contenido']); ?>" title="Modificar p&aacute;gina" class="btn btn-primary btn-sm pull-right"><i class="fa fa-pencil"></i> Modificar</a> 
			                    		<?php } ?>
			                        </p>
			                    	<?php } else { ?>
				                        ...
				                        <a href="<?php echo base_url('cms-v2/paginas/configuracion/').$obj['id_contenido']; ?>" title="Configurar p&aacute;gina" class="btn btn-primary btn-sm pull-right"><i class="fa fa-cog"></i> Configuraci&oacute;n</a> 
			                    		<a href="<?php echo base_url('cms-v2/paginas/modificar/'.$obj['id_contenido']); ?>" title="Modificar p&aacute;gina" class="btn btn-primary btn-sm pull-right"><i class="fa fa-pencil"></i> Modificar</a> 
			                    		</p>
			                    	<?php } ?>
...
<!--
			                    ...
			                    <?php foreach($listado as $lista) { ?>	
				                       ...
				                       <td><?php echo ($lista['padre']) ? $lista['padre'] : '------'; ?></td>
				                       <td><?php echo $lista['descripcion']; ?></td>
				                       <td><?php echo $lista['estado']; ?></td>
				                       <td><a href="<?php echo base_url('cms-v2/paginas/modificar/'.$lista['id_contenido']); ?>" title="Modificar p&aacute;gina" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> Modificar</a> 
				                        <a href="<?php echo base_url('cms-v2/paginas/ingresar_seccion/').$lista['id']; ?>" title="Configurar p&aacute;gina"" class="btn btn-success btn-sm"><i class="fa fa-cog"></i> Configuraci&oacute;n</a> 
				                        <a title="Cambiar publicaci&oacute;n" id="item" href="#" data-toggle="modal" data-idioma='<?php echo $lista['id_estado'];?>' data-seccion='<?php echo $lista['seccion'];?>?' data-id="<?php echo $lista['id'];?>" data-target="#myModalcuatro" <?php echo ($lista['id_estado'] == 3) ? 'class="btn btn-sm btn-danger"><i class="fa fa-download"></i> Dejar de publicar' : 'class="btn btn-sm btn-primary"><i class="fa fa-upload"></i> Publicar secci&oacute;n &nbsp;';?></a>
				                       </td>
				                    </tr>
			                    <?php } ?>	
			                    </tbody>
