					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Contenido General</h2>
											<div class="form-group m-b-md pull-left full-width m-t-md">
							                    <div class="col-sm-12">
													<div class="ibox-title bg-muted m-t-md"><h5>Contenido 1</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Contenido para Misión. Recuerde que la imagen se carga desde Multimedia y se asocia pegando la url desde el ícono Picture, para los títulos celestes son Header h4, los subtítulos azules son Header h6 y el texto con etiqueta párrafo p." title=""> <i class="fa fa-question"></i></button></div>
											...
											<div class="form-group m-b-md pull-left full-width m-t-md">
							                    <div class="col-sm-12">
													<div class="ibox-title bg-muted m-t-md"><h5>Contenido 2</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Contenido para Visión. Recuerde que la imagen se carga desde Multimedia y se asocia pegando la url desde el ícono Picture, para los títulos celestes son Header h4, los subtítulos azules son Header h6 y el texto con etiqueta párrafo p." title=""> <i class="fa fa-question"></i></button></div>
													<div class="ibox-content no-padding">
											...
											<div class="form-group m-b-md pull-left full-width m-t-md">
							                    <div class="col-sm-12">
													<div class="ibox-title bg-muted m-t-md"><h5>Contenido 3</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Contenido para Objetivos. Recuerde que la imagen se carga desde Multimedia y se asocia pegando la url desde el ícono Picture, para los títulos celestes son Header h4, los subtítulos azules son Header h6 y el texto con etiqueta párrafo p." title=""> <i class="fa fa-question"></i></button></div>
													<div class="ibox-content no-padding">
