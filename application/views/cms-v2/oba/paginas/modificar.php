	                ...
	                <div class="ibox float-e-margins">
	                    ...
	                    <div class="ibox-content">
							...
							<div class="form-group">
                            	...
                            	<label class="col-sm-2 control-label">Publicar texto<br></label>
			                    <div class="col-sm-3">
								...
								<?php } else { ?>
                            	<label class="col-sm-2 control-label">Categor&iacute;a (no slide)<br></label>
			                    <div class="col-sm-3">
                            	...
                            	<label class="col-sm-2 control-label">Ubicaci&oacute;n (sólo historia)<br></label>
			                    <div class="col-sm-4 col-md-4">
		                            <select name="texto_adicional" class="form-control m-b">
		                                <option value="">Seleccione</option>
		                                <option value="izquierda" <?php echo ($item['texto_adicional'] == 'izquierda') ? 'selected' :'';?>>A la izquierda</option>
		                                <option value="derecha" <?php echo ($item['texto_adicional'] == 'derecha') ? 'selected' :'';?>>A la derecha</option>
		                            </select>
			                    </div>
			                </div>
                            ...
                            <div class="form-group">
			                    ...
			                    <div class="col-sm-3 col-md-3">
                                    <div class="input-group">
                                    	<input type="text" name="titulo" class="form-control" value="<?php echo (isset($item['titulo'])) ? $item['titulo']: null; ?>"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Nombre de la categoría según idioma." title=""> <i class="fa fa-question"></i></button></span>
                                    </div>
			                    </div>
			                    ...
			                    <div class="col-sm-4 col-md-4">
                                    <div class="input-group">
                                    	<input type="text" name="subtitulo" class="form-control" value="<?php echo (isset($item['subtitulo'])) ? $item['subtitulo']: null; ?>"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Nombre de la categoría según idioma." title=""> <i class="fa fa-question"></i></button></span>
                                    </div>
			                    </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
			                    ...
			                    <div class="col-sm-3 col-md-3">
		                            <select name="id_imagen_tipo" class="form-control m-b">
		                                <option value="18"<?php echo($item['id_tipo'] == 8) ? ' selected':''; ?>>1200x400 (slide)</option>
		                                <option value="15"<?php echo($item['id_tipo'] == 86 || $item['id_tipo'] == 87 || $item['id_tipo'] == 88) ? ' selected':''; ?>>150x150 (miembros)</option>
		                                <option value="16"<?php echo($item['id_tipo'] == 89 || $item['id_tipo'] == 90 || $item['id_tipo'] == 91) ? ' selected':''; ?>>385x105 (patrocinadores)</option>
		                                <option value="17"<?php echo($item['id_tipo'] == 92) ? ' selected':''; ?>>180x180 (historia)</option>
		                            </select>
			                    </div>
                           ...
                           <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
			                    ...
			                    <div class="col-sm-2">
                                    <div class="input-group">
                                    	<input type="text" name="orden" class="form-control" value="<?php echo (isset($item['orden'])) ? $item['orden']: null; ?>"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Orden en el que se mostrará la categoría." title=""> <i class="fa fa-question"></i></button></span>
                                    </div>
			                    </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
					            	...
					            	<?php if($this->uri->segment(4) == 76) {?>
						            	<input type="hidden" name="medidas" value="1200x400" />
					            	<?php } elseif($this->uri->segment(4) == 83) {?>
						            	<input type="hidden" name="medidas" value="150x150" />
					            	<?php } elseif($this->uri->segment(4) == 84) {?>
						            	<input type="hidden" name="medidas" value="385x105" />
					            	<?php } elseif($this->uri->segment(4) == 87) {?>
						            	<input type="hidden" name="medidas" value="180x180" />
					            	<?php } ?>
