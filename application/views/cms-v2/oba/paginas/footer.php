	   		...
	   		<div class="modal-content animated">
		        ...
		        <div class="modal-body p-xs pull-left full-width">
			        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/ingresar_informacion/'); ?>">
	                   ...
	                   <div class="col-sm-6">
		                    <label class="control-label pull-left">Ubicación (sólo Historia)</label>
                            <select name="texto_adicional" class="form-control m-b">
                                <option value="">Seleccione</option>
                                <option value="izquierda">A la izquierda</option>
                                <option value="derecha">A la izquierda</option>
                            </select>
		                </div>
	                    <div class="col-sm-6">
		                    <label class="control-label pull-left">Tamaño Imagen</label>
                            <select name="id_imagen_tipo" class="form-control m-b">
                                <option value="15">150x150 (miembros)</option>
                                <option value="16">385x105 (patrocinadores)</option>
                                <option value="17">180x180 (historia)</option>
                            </select>
						</div>
...
<!-- Modal Modificar -->
    <div class="modal inmodal" id="myModalModificarInformacion" tabindex="-1" role="dialog" aria-hidden="true">
	    <div class="modal-dialog modal-lg">
	   		<div class="modal-content animated">
		        <div class="modal-header">
		            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
		            <h4 class="modal-title">Modificar contenido de <input type="text" name="seccion" id="seccion" value="" readonly="true" style="border:none; background:#fff;text-align:center; width:auto !important;"/></h4>
		        </div>
		
		        <div class="modal-body p-xs pull-left full-width">
			        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/modificar_informacion/'); ?>">
	                    <div class="col-sm-6">
		                    <label class="control-label pull-left">Categoría</label>
                            <select name="id_tipo" class="form-control m-b">
                                <?php foreach($categorias as $categoria) { ?>
	                   ...
	                   <div class="col-sm-6">
		                    <label class="control-label pull-left">Ubicación (sólo Historia)</label>
                            <select name="subtitulo" class="form-control m-b">
                                <option value="">Seleccione</option>
                                <option value="izquierda">A la izquierda</option>
                                <option value="derecha">A la izquierda</option>
                            </select>
	                   ...
	                   <div class="col-sm-12 m-b-sm">
	                    ...
	                    <div class="col-sm-12 m-b-sm">
		                    <label class="control-label pull-left">Texto</label>
								<div class="ibox-content no-padding">
								    <textarea class="form-control summernote2" name="contenido1" id="contenido" rows="4"  value=""></textarea></div>
						</div>
	                   ...
	                   <div class="col-sm-12 m-b-sm">
	                    ...
	                    <div class="col-sm-12 m-b-sm">
                            ...
                            <div class="fileinput fileinput-new input-group p-xs" data-provides="fileinput">
	                            <input type="file" name="imagen">
	                    	</div>
						</div>
			        ...
			        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/ingresar_informacion/'); ?>">
	                   ...
	                   <div class="col-sm-12 m-b-sm">
	                    ...
	                    <div class="col-sm-12 m-b-sm">
	                    	...
	                    	<small class="font-italic">Recomendado 1200 x 400 píxeles. Recuerde que el peso debe ser el mínimo posible para no afectar la descarga del site.</small>
	                    </div>
	                    ...
	                    <div class="col-sm-12 m-t-sm">
			            	...
			            	<input type="hidden" name="idioma" id="idioma" value="" />
			            	<input type="hidden" name="id_contenido" value="76" />
			                <input type="submit" class="btn btn-primary pull-right" value="Ingresar">
	                    </div>
		            </form>
		        </div>
