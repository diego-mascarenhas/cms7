       <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <form action="https://cms.revisionalpha.com/cms-v2/paginas/configuracion/<?php echo $detalle['id']; ?>/" class="form-horizontal" method="post" accept-charset="utf-8">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox-title ibox-title-custom"><h5>Configuraci&oacute;n de p&aacute;gina <a href="<?php echo base_url('cms-v2/paginas/modificar/'.$detalle['id']);?>"><?php echo $detalle['seccion']; ?></a></h5></div>
                </div>
					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">SEO</h2>
					                 	<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" name="url_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['url'])) ? $item['url']: null; ?>" readonly="true"></div>
					                 	</div>
					                </div>
