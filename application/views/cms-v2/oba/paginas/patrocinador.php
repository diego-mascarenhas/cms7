					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Contenido General</h2>
					                 	<div class="form-group">
											...
											<div class="col-sm-5">
		                                        <div class="input-group">
													<input type="text" name="texto_adicional_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['texto_adicional'])) ? $item['texto_adicional'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Subtítulo de la sección, en color verde." title=""> <i class="fa fa-question"></i></button>
			                                    </div>
			                                </div>
											<label class="col-sm-2 control-label">Proyecto Galería</label>
											<div class="col-sm-4">
		                                        <div class="input-group">
		                                        <?php echo form_dropdown('subtitulo_'.$idioma['extension'], $media_proyectos, (isset($item['subtitulo'])) ? $item['subtitulo'] : null, 'class="form-control m-b"'); ?>
		                                        	<span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Galería de imágenes asociada a la sección. Se debe seleccionar Patrocinadores." title=""> <i class="fa fa-question"></i></button>

<!-- 													<input type="text" name="subtitulo_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['subtitulo'])) ? $item['subtitulo'] : null; ?>"> -->
			                                    </div>
											</div>
					                 	</div>
				                 	</div>
					                <div class="col-lg-12 p-xxs">
					                 	<div class="form-group">
											<label class="col-sm-1 control-label">Título Brochure</label>
											<div class="col-sm-5">
		                                        <div class="input-group">
													<input type="text" name="contenido3_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['contenido3'])) ? $item['contenido3'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título del link de brochure en PDF." title=""> <i class="fa fa-question"></i></button>
			                                    </div>
			                                </div>
											<label class="col-sm-2 control-label">URL Brochure</label>
											<div class="col-sm-4">
		                                        <div class="input-group">
													<input type="text" name="contenido4_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['contenido4'])) ? $item['contenido4'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="URL del PDF que se carga en Multimedia y debe copiarse y pegarse aquí." title=""> <i class="fa fa-question"></i></button>
			                                    </div>
			                                </div>
					                 	</div>
				                 	</div>
					                <div class="col-lg-12 p-xxs">
					                 	<div class="form-group">
						                    <div class="col-sm-6">
												<div class="ibox-title bg-muted m-t-md"><h5>Lista 1</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Columna 1 de lista de beneficios de ser patrocinador." title=""> <i class="fa fa-question"></i></button></div>
						                    ...
						                    <div class="col-sm-6">
												<div class="ibox-title bg-muted m-t-md"><h5>Lista 2</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Columna 2 de lista de beneficios de ser patrocinador." title=""> <i class="fa fa-question"></i></button></div>
												<div class="ibox-content no-padding">
...
<script src="<?php echo base_url('assets/js/summernote-ext-addclass.js'); ?>"></script>
<script>
