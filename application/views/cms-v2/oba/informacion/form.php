								 ...
								 <div class="row">
					                ...
					                <div class="col-lg-12 p-xxs">
										<div class="form-group m-b-md pull-left full-width m-t-md">
											...
											<div class="col-sm-2 pull-left text-right"><a class="btn btn-warning" href="<?php echo base_url('cms-v2/categorias');?>">Gestionar categor&iacute;as</a></div>
				                 		</div>
					                </div>
					                ...
					                <div class="col-lg-12 p-xxs">
										<div class="form-group m-b-md pull-left full-width m-t-md">
						                    <label class="text-right col-sm-1 control-label">Instituci&oacute;n </label>
						                    <div class="col-sm-4">
		                                        <div class="input-group">
						                    <?php echo (isset($detalle['filtro1'])) ? form_dropdown('filtro1', $instituciones, $detalle['filtro1'], array('class'=>'form-control m-b')) : form_dropdown('filtro1', $instituciones, null, array('class'=>'form-control m-b')); ?>
													<span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Determina el logo que se mostrará en el listado de 3 principales. Se se selecciona OBA se mostrará el logo insticional." title=""> <i class="fa fa-question"></i></button>
			                                    </div>
						                    </div>
					                ...
					                <div class="col-lg-12 p-xxs">
										<div class="form-group m-b-md pull-left full-width m-t-md">
				                            ...
				                            <div class="col-sm-4">
					                            ...
					                            <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Determina si el contenido se mostrará en el slideshow principal." title=""> <i class="fa fa-question"></i></button>
					                         </div>
			                            </div>
								   </div>
							...
							?>
	                            <div class="panel-body">
								 <div class="row">
					                ...
					                <div class="col-lg-6 p-xxs">
										<?php if((isset($item['titulo'])) && $archivo['archivo']) { ?>
											<div class="form-group m-b-md pull-left full-width m-t-md">
			                            		...
			                            		<div class="col-sm-8">
			                            			<img src="<?php echo base_url('/multimedia/' . $this->usuario->grupo . '/' . $this->usuario->id_empresa . '/'.$archivo['archivo']);?>" style="height:auto;width:250px;float: left;padding-bottom: 24px;padding-right: 25px;"/></div>
											</div>
										<?php } ?>
							                ...
							                <div class="col-sm-8">
		                                        <div class="input-group">
		                                        	<input type="file" name="archivo1_<?php echo $idioma['extension'];?>" class="form-control"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Se usa para los Documentos, es el archivo PDF a descargar." title=""> <i class="fa fa-question"></i></button></span>
			                                    </div>
							                </div>
				                 		</div>
					                </div>
									...
									<input type="hidden" name="url_slide_<?php echo $idioma['extension'];?>" value="http://bomberosamericanos.org/<?php echo $idioma['extension'];?>/noticias">
			                    </div>
			                </div>
						</div>
                       	<?php } ?>
