...
<link href="<?php echo base_url('assets/css/plugins/dataTables/datatables.min.css'); ?>" rel="stylesheet" type="text/css">
       ...
       <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-xs-4 col-sm-4 col-lg-4" style="margin-top:34px; text-align:right;">
                <a href="<?php echo base_url('cms-v2/informacion/ingresar/'); ?>" class="btn btn-primary">Ingresar</a>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
	                <div class="ibox float-e-margins">
                    	<div class="ibox-title"><h5>Listado de Información</h5></div>
	                    <div class="ibox-content">
	                        <div class="table-responsive">
				                <div class="col-sm-4 m-b-xs botones-filtros">
			                    	<div class="btn-group">
				                        <a class="btn btn-sm btn-white<?php echo ($tipo == 'todos') ? ' active':'';?>" href="<?php echo base_url('cms-v2/informacion');?>">Todos </a>
				                        <a class="btn btn-sm btn-white<?php echo ($tipo == '9') ? ' active':'';?>" href="<?php echo base_url('cms-v2/informacion?tipo=9');?>">Noticias</a>
				                        <a class="btn btn-sm btn-white<?php echo ($tipo == '10') ? ' active':'';?>" href="<?php echo base_url('cms-v2/informacion?tipo=10');?>">Documentos </a>
			                        </div>
				                </div>
			                   ...
			                   <?php if($listado) { foreach($listado as $lista) { ?>	
			                        ...
			                        <td>
				                        <a href="<?php echo base_url('cms-v2/informacion/modificar/').$lista['id']; ?>" title="Modificar" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Modificar</a> 
				                        <a href="<?php echo base_url('cms-v2/informacion/duplicar/').$lista['id']; ?>" title="Duplicar" class="btn btn-primary btn-sm"><i class="fa fa-copy"></i> Duplicar</a>
				                        <a href="<?php echo base_url('cms-v2/informacion/ordenar/').$lista['id_con_secciones']; ?>" title="Ordenar" class="btn btn-primary btn-sm"><i class="fa fa-sort"></i> Ordenar</a>
				                        <a title="Eliminar" id="item" href="#" data-toggle="modal" data-seccion="<?php echo $lista['titulo'];?>" data-estado="<?php echo $lista['id_estado'];?>" data-id="<?php echo $lista['id'];?>" data-target="#myModalEliminarInformacion" class="sepV_a btn btn-primary btn-sm"><i class="fa fa-minus-circle"></i> Eliminar</a></td>
			                    </tr>
			                   <?php } } ?>	
