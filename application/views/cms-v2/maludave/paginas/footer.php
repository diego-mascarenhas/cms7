	   		...
	   		<div class="modal-content animated">
		        ...
		        <div class="modal-body p-xs pull-left full-width">
			        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/ingresar_informacion/'); ?>">
		                ...
		                <?php if($detalle['id_con_secciones'] == 214) { ?>
	                    <div class="col-sm-6">
		                    <label class="control-label pull-left">Tamaño Imagen</label>
                            <select name="id_imagen_tipo" class="form-control m-b">
                                <option value="14" selected>505x505 (noticias)</option>
                            </select>
						</div>
		                <?php } elseif($detalle['id_con_secciones'] == 156) {  ?>
	                    <div class="col-sm-6">
		                    <label class="control-label pull-left">Tamaño Imagen</label>
                            <select name="id_imagen_tipo" class="form-control m-b">
                                <option value="13" selected>240x84 (logos)</option>
                            </select>
						</div>
		                <?php } ?>
	                   ...
	                   <div class="col-sm-12 m-b-sm">
	                    ...
	                    <div class="col-sm-12 m-t-sm">
			            	...
			            	<?php if($detalle['id_con_secciones'] == 214) { ?>
			            	<input type="hidden" name="medidas" value="505x505" />
			            	<?php } else { ?>
			            	<input type="hidden" name="medidas" value="240x84" />
			            	<?php } ?>
			        ...
			        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/ingresar_informacion/'); ?>">
	                   ...
	                   <div class="col-sm-12 m-b-sm">
	                    ...
	                    <div class="col-sm-12 m-b-sm">
	                    	...
	                    	<small class="font-italic">Recomendado 1340 x 470 píxeles. Recuerde que el peso debe ser el mínimo posible para no afectar la descarga del site.</small>
	                    </div>
    ...
    <div class="modal inmodal" id="myModalIngresarNovedad" tabindex="-1" role="dialog" aria-hidden="true">
	    <div class="modal-dialog modal-lg">
	   		<div class="modal-content animated">
		        <div class="modal-header">
		            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
		            <h4 class="modal-title">Ingresar ítem de <input type="text" name="seccion" id="seccion" value="" readonly="true" style="border:none; background:#fff;text-align:center; width:auto !important;"/></h4>
		        </div>
			        ...
			        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/ingresar_informacion/'); ?>">
	                   ...
	                   <div class="col-sm-6">
	                    ...
	                    <div class="col-sm-12 m-b-sm">
	                    	...
	                    	<small class="font-italic">Recomendado 370x270 píxeles. Recuerde que el peso debe ser el mínimo posible para no afectar la descarga del site.</small>
	                    </div>

	                    <div class="col-sm-12 m-t-sm">
			            	<input type="hidden" name="id" id="id" value="" />
			            	<input type="hidden" name="id_tipo" id="id_tipo" value="222" />
			            	<input type="hidden" name="idioma" id="idioma" value="" />
			            	<input type="hidden" name="medidas" value="370x270" />
			            	<input type="hidden" name="id_contenido" id="id_contenido" value="" />
			                <input type="submit" class="btn btn-primary pull-right" value="Ingresar">
	                    </div>
		            </form>
