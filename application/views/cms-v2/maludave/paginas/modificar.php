	                    ...
	                    <div class="ibox-content">
                            ...
                            <div class="form-group">
			                    ...
			                    <div class="col-sm-3 col-md-3">
                                    <div class="input-group">
                                    	<input type="text" name="titulo" class="form-control" value="<?php echo (isset($item['titulo'])) ? $item['titulo']: null; ?>"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título del contenido." title=""> <i class="fa fa-question"></i></button></span>
                                    </div>
			                    </div>
			                    ...
			                    <div class="col-sm-4 col-md-4">
                                    <div class="input-group">
                                    	<input type="text" name="subtitulo" class="form-control" value="<?php echo (isset($item['subtitulo'])) ? $item['subtitulo']: null; ?>"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Link del botón." title=""> <i class="fa fa-question"></i></button></span>
                                    </div>
			                    </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
				                ...
				                <div class="col-lg-6 p-xxs">
									...
									<?php } ?>
						                ...
						                <div class="col-sm-8">
	                                        <div class="input-group">
		                                       <input type="file" name="imagen" class="form-control"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="En el caso del slide debe tener 1340x470 píxeles o proporcionales mayores." title=""> <i class="fa fa-question"></i></button>
		                                    </div>
						                </div>
									</div>
								</div>
                           ...
                           <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
			                    ...
			                    <div class="col-sm-2">
                                    <div class="input-group">
                                    	<input type="text" name="orden" class="form-control" value="<?php echo (isset($item['orden'])) ? $item['orden']: null; ?>"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Orden en el que se mostrará el contenido." title=""> <i class="fa fa-question"></i></button></span>
                                    </div>
			                    </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
					            	...
					            	<input type="hidden" name="medidas" value="1340x470" />
					            	<input type="hidden" name="id_imagen_tipo" value="18" />
