...
.p_b_25 { padding-bottom:25px !important;}
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-xs-8 col-sm-8 col-lg-8">
                <h2>Sitio web Blog</h2>
                <ol class="breadcrumb">
                    <li>
                        <a href="/cms">Home</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('cms-v2/noticias/');?>">Blog</a>
                    </li>
                    <li class="active">
        ...
        <div class="wrapper wrapper-content animated fadeInRight p_b_25">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox-title ibox-title-custom"><h5>Subir noticia</h5>
					</div>
                </div>
        ...
        <div class="wrapper wrapper-content animated fadeInRight" style="padding-top:0 !important;">
			<div class="row">
				...
				<div class="ibox-title" style="padding-bottom:52px;"><h5>Ingresar nuevo contenido para </h5>
					<div class="col-sm-2">
						<?php echo (isset($contenido['id_con_secciones'])) ? form_dropdown('seccion', $secciones, $contenido['id_con_secciones'], array('class'=>'form-control m-b')) : form_dropdown('seccion', $secciones, null, array('class'=>'form-control m-b')); ?>
					</div>
					<div class="col-sm-1 pull-left text-right">
		                 <a class="btn btn-warning" href="<?php echo base_url('cms-v2/noticias/categorias');?>">Gestionar categor&iacute;as</a>
					</div>
				</div>
				</div>
			</div>
            ...
            <div class="row">
				<div class="col-lg-12">
	                <div class="ibox float-e-margins">
	                    <div class="ibox-title"><h5>Información de la noticia</h5>
	                    ...
	                    <div class="ibox-content" style="float:left;">
		                 	<div class="form-group">
			                    ...
			                    <div class="col-sm-3 col-md-3"><input type="text" name="titulo" class="form-control" value="<?php echo (isset($item['id'])) ? $item['titulo']: null; ?>"></div>
			                    <label class="text-right col-sm-1 control-label">Nombre (url)</label>
			                    <div class="col-sm-3 col-md-3"><input type="text" name="url" class="form-control" value="<?php echo (isset($item['id'])) ? $item['url']: null; ?>"></div>
			...
			<div class="col-lg-12" style="margin-bottom:25px;">
                <div class="ibox float-e-margins">
                    <div class="ibox-title"><h5>Imágenes de la galería</h5>
				       <div class="ibox-tools"><a class="collapse-link pull-right"><i class="fa fa-chevron-up"></i></a> <?php if(!empty($fotos)) { ?>
                         <a class="btn btn-primary pull-right" type="submit" href="<?php echo base_url('cms-v2/noticias/ordenar/'.$contenido['id']);?>" style="margin-top:-8px; margin-right:10px;">Ordenar</a><?php } ?></div>
                    </div>
                    ...
                    <div class="ibox-content" style="float: left; width:100%;">
						...
						<div class="col-lg-12">
							...
							<div class="table-responsive" style="background: none; border:0;">
								<?php echo form_open('cms-v2/noticias/upload', array('class' =>'dropzone'));?>
	    ...
	    <div class="modal-content animated">
	        ...
	        <div class="modal-body">
		        ...
		        <div class="modal-footer">
		        	<form name="eliminar" class="form_eliminar" method="post" action="<?php echo base_url('cms-v2/noticias/eliminarmedia/'); ?>">
