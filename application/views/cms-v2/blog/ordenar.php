        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-xs-8 col-sm-8 col-lg-8">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo base_url('cms-v2/noticias/');?>">Noticias</a>
                    </li>
                    <li class="active">
                ...
                <div class="col-lg-12">
                	<div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h5>Ordenar imágenes de la noticia <a href="/cms-v2/noticias/ingresar/<?php echo $item['id_contenido'];?>"><?php echo $item['titulo'];?></a></h5>
	                    </div>
                	</div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-10">
                    <ul class="sortable-list connectList agile-list" id="media">
                        ...
                        <img src="<?php echo base_url('/multimedia/511/7358/'.$lista['imagen']); ?>" style="width:120px;">
    ...
    <script>
        $(document).ready(function(){
            ...
            update: function( event, ui ) {
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url('cms-v2/noticias/ordenarMedia/media'); ?>',
