        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-xs-8 col-sm-8 col-lg-8">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                            <strong>Ordenar Categor&iacute;as</strong>
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                	<div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h5>Ordenar Categor&iacute;as</h5>
	                    </div>
                	</div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            update: function( event, ui ) {
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url('cms-v2/noticias/ordenarCategorias'); ?>',
