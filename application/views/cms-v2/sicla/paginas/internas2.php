					                ...
					                <?php 
					                    ...
					                    <div class="col-sm-12 p-xxs m-t-md">
						                    <div class="pull-left full-width">
							                	...
							                	<a title="Ingresar" id="item" href="#" data-toggle="modal" data-seccion="<?php echo $detalle['seccion']; ?>" data-id_contenido="<?php echo $detalle['id'];?>" data-idioma="<?php echo $idioma['extension'];?>" <?php if( ($categoria['id'] == 566) || ($categoria['id'] ==590)) { ?>data-target="#myModalIngresarInformacion2" <?php } else { ?>data-target="#myModalIngresarInformacion"<?php } ?> class="sepV_a btn btn-primary btn-sm red pull-right"><i class="fa fa-plus-circle"></i> Ingresar</a></h3>
