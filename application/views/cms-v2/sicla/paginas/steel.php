...
.contact-box { min-height: 160px;max-height: 200px; padding:20px 10px;display: flex;flex-direction: column;justify-content: center;}
					                ...
					                <div class="col-lg-12 p-xxs">
						                ...
						                <div class="form-group pull-left full-width">
						                    ...
						                    <div class="col-sm-5">
					                            <?php if(!empty($imagen)) { ?>
					                            <div class="col-sm-12">
					                            	<img src="/multimedia/thumbs/<?php echo $imagen['imagen_breadcrumb'];?>" style="height:auto;height:100px;float: left;padding-bottom: 24px;padding-right: 25px;"/>
					                            </div>
				                            	<?php } ?>
					                            <div class="col-sm-12">
		                                        	<div class="input-group">
						                            	<input type="file" name="imagen_<?php echo $idioma['extension'];?>" class="form-control"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Logo. El tamaño debe ser 360x200 píxeles o proporcionales y debe tener el menor peso posible para mejorar la carga de la sección."> <i class="fa fa-question"></i></button>
						                            </div>
					                            </div>
											</div>
					                 	</div>
						                ...
						                <div class="form-group pull-left full-width">
											...
											<div class="col-sm-5">
		                                        <div class="input-group">
													<input type="text" name="subtitulo_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['subtitulo'])) ? $item['subtitulo'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Frase sobre fondo marrón claro."> <i class="fa fa-question"></i></button>
			                                    </div>
											</div>
											<label class="col-sm-1 control-label">Fondo</label>
						                    <div class="col-sm-5">
					                            <?php if(!empty($imagen2)) { ?>
					                            <div class="col-sm-12">
					                            	<img src="/multimedia/thumbs/<?php echo $imagen2['imagen_breadcrumb'];?>" style="height:auto;height:100px;float: left;padding-bottom: 24px;padding-right: 25px;"/>
					                            </div>
				                            	<?php } ?>
					                            <div class="col-sm-12">
		                                        	<div class="input-group">
						                            	<input type="file" name="imagen2_<?php echo $idioma['extension'];?>" class="form-control"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Imagen de fondo. PNG con fondo transparante. El tamaño debe ser 580x440 píxeles o proporcionales y debe tener el menor peso posible para mejorar la carga de la sección."> <i class="fa fa-question"></i></button>
						                            </div>
					                            </div>
											</div>
					                 	</div>
					                    ...
					                    <div class="col-sm-12 p-xxs m-t-md">
						                    <div class="form-group pull-left full-width">
							                	<h3 class="bg-muted p-xs pull-left full-width">Cómo trabajamos<a title="Ordenar" href="<?php echo base_url('cms-v2/paginas/ordenar/'.$detalle['id'].'/867/'.$idioma['extension']);?>" class="sepV_a btn btn-primary btn-sm red pull-right m-l-sm"><i class="fa fa-sort-circle"></i> Ordenar</a> 
							                	<a title="Ingresar" id="item" href="#" data-toggle="modal" data-seccion="<?php echo $detalle['seccion']; ?>" data-id_contenido="<?php echo $detalle['id'];?>" data-idioma="<?php echo $idioma['extension'];?>" data-target="#myModalIngresarInformacion867" class="sepV_a btn btn-primary btn-sm red pull-right"><i class="fa fa-plus-circle"></i> Ingresar</a></h3>
												<label class="col-sm-2 control-label">Título</label>
												<div class="col-sm-4">
			                                        <div class="input-group">
														<input type="text" name="texto_adicional_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['texto_adicional'])) ? $item['texto_adicional'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Código del video."> <i class="fa fa-question"></i></button>
				                                    </div>
												</div>
											</div>
						                    <div class="form-group pull-left full-width">
										...
										<?php } } else { echo 'No se encontraron resultados';} ?>
						                    ...
						                    <div class="form-group pull-left full-width">
							                	<h3 class="bg-muted p-xs pull-left full-width">Box de Texto</h3>
							                    <div class="col-sm-12">
													<div class="ibox-title bg-muted m-t-md"><h5>Contenido</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Contenido de la sección con imagen diagonal de fondo."> <i class="fa fa-question"></i></button></div>
						                    ...
						                    <div class="form-group pull-left full-width">
							                	<h3 class="bg-muted p-xs pull-left full-width">Ventajas<a title="Ordenar" href="<?php echo base_url('cms-v2/paginas/ordenar/'.$detalle['id'].'/870/'.$idioma['extension']);?>" class="sepV_a btn btn-primary btn-sm red pull-right m-l-sm"><i class="fa fa-sort-circle"></i> Ordenar</a> 
							                	<a title="Ingresar" id="item" href="#" data-toggle="modal" data-seccion="<?php echo $detalle['seccion']; ?>" data-id_contenido="<?php echo $detalle['id'];?>" data-idioma="<?php echo $idioma['extension'];?>" data-target="#myModalIngresarInformacion870" class="sepV_a btn btn-primary btn-sm red pull-right"><i class="fa fa-plus-circle"></i> Ingresar</a></h3>
												<label class="col-sm-2 control-label">Título</label>
												<div class="col-sm-4">
			                                        <div class="input-group">
														<input type="text" name="url_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['url'])) ? $item['url'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título de listado de ventajas."> <i class="fa fa-question"></i></button>
				                                    </div>
												</div>
											</div>
						                    <div class="form-group pull-left full-width">
					                    ...
					                    <div class="form-group pull-left full-width">
						                    ...
						                    <div class="form-group pull-left full-width">
							                	<h3 class="bg-muted p-xs pull-left full-width">Testimonios<a title="Ordenar" href="<?php echo base_url('cms-v2/paginas/ordenar/'.$detalle['id'].'/873/'.$idioma['extension']);?>" class="sepV_a btn btn-primary btn-sm red pull-right m-l-sm"><i class="fa fa-sort-circle"></i> Ordenar</a> 
							                	<a title="Ingresar" id="item" href="#" data-toggle="modal" data-seccion="<?php echo $detalle['seccion']; ?>" data-id_contenido="<?php echo $detalle['id'];?>" data-idioma="<?php echo $idioma['extension'];?>" data-target="#myModalIngresarInformacion873" class="sepV_a btn btn-primary btn-sm red pull-right"><i class="fa fa-plus-circle"></i> Ingresar</a></h3>
												<label class="col-sm-2 control-label">Título</label>
												<div class="col-sm-4">
			                                        <div class="input-group">
														<input type="text" name="contenido6_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['contenido6'])) ? $item['contenido6'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título de listado de testimonios."> <i class="fa fa-question"></i></button>
				                                    </div>
												</div>
											</div>
						                    <div class="form-group pull-left full-width">
					                    ...
					                    <div class="form-group pull-left full-width">
						                    ...
						                    <div class="col-sm-12">
												<div class="ibox-title bg-muted m-t-md"><h5>Contenido</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Contenido de la sección con imagen diagonal de fondo."> <i class="fa fa-question"></i></button></div>
												<div class="ibox-content no-padding">
												    <textarea class="form-control summernote" name="contenido3_<?php echo $idioma['extension'];?>" rows="3"><?php echo(isset($item['contenido3'])) ? $item['contenido3']: null?></textarea></div>
						                    </div>
					                    </div>
					                    <div class="form-group pull-left full-width">
						                	<h3 class="bg-muted p-xs pull-left full-width">Nuestros Miembros<a title="Ordenar" href="<?php echo base_url('cms-v2/paginas/ordenar/'.$detalle['id'].'/879/'.$idioma['extension']);?>" class="sepV_a btn btn-primary btn-sm red pull-right m-l-sm"><i class="fa fa-sort-circle"></i> Ordenar</a> 
						                	<a title="Ingresar" id="item" href="#" data-toggle="modal" data-seccion="<?php echo $detalle['seccion']; ?>" data-id_contenido="<?php echo $detalle['id'];?>" data-idioma="<?php echo $idioma['extension'];?>" data-target="#myModalIngresarInformacion879" class="sepV_a btn btn-primary btn-sm red pull-right"><i class="fa fa-plus-circle"></i> Ingresar</a></h3>
											<label class="col-sm-2 control-label">Título</label>
											<div class="col-sm-4">
		                                        <div class="input-group">
													<input type="text" name="contenido7_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['contenido7'])) ? $item['contenido7'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título de listado de testimonios."> <i class="fa fa-question"></i></button>
			                                    </div>
											</div>
										</div>
...
<div class="modal inmodal" id="myModalIngresarInformacion873" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
   		<div class="modal-content animated">
	        <div class="modal-header">
	            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
	            <h4 class="modal-title">Ingresar Testimonio</h4>
	        </div>
	        ...
	        <div class="modal-body p-xs pull-left full-width">
		        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/ingresar_informacion/'); ?>">
	                ...
	                <div class="col-sm-12 m-b-sm">
	                    ...
	                    <textarea class="form-control summernote" name="contenido1" rows="3"><?php echo(isset($item['contenido1'])) ? $item['contenido1']: null?></textarea>
	                </div>
                    <div class="col-sm-12 m-b-sm">
...
<div class="modal inmodal" id="myModalIngresarInformacion870" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
   		<div class="modal-content animated">
	        <div class="modal-header">
	            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
	            <h4 class="modal-title">Ingresar Ventaja</h4>
	        </div>
	        ...
	        <div class="modal-body p-xs pull-left full-width">
		        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/ingresar_informacion/'); ?>">
                    ...
                    <div class="col-sm-12 m-t-sm">
		            	<input type="hidden" name="id" id="id" value="">
		            	<input type="hidden" name="id_tipo" id="id_tipo" value="870">
		            	<input type="hidden" name="idioma" id="idioma" value="">
		            	<input type="hidden" name="id_contenido" id="id_contenido" value="">
		                <input type="submit" class="btn btn-primary pull-right" value="Ingresar">
                    </div>
...
<!-- Modal Ingresar Miembros -->
<div class="modal inmodal" id="myModalIngresarInformacion879" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
   		<div class="modal-content animated">
	        <div class="modal-header">
	            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
	            <h4 class="modal-title">Ingresar Miembro</h4>
	        </div>
	        ...
	        <div class="modal-body p-xs pull-left full-width">
		        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/ingresar_informacion/'); ?>">
                    ...
                    <div class="col-sm-12 m-t-sm">
		            	<input type="hidden" name="id" id="id" value="">
		            	<input type="hidden" name="id_tipo" id="id_tipo" value="879">
		            	<input type="hidden" name="idioma" id="idioma" value="">
		            	<input type="hidden" name="id_contenido" id="id_contenido" value="">
