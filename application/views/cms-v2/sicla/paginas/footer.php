<!-- Modal Ingresar Info Prototipos -->
    <div class="modal inmodal" id="myModalIngresarInformacion2" tabindex="-1" role="dialog" aria-hidden="true">
		        ...
		        <div class="modal-body p-xs pull-left full-width">
			        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/ingresar_informacion/'); ?>">
	                    ...
	                    <div class="col-sm-12 m-t-sm">
			            	...
			            	<?php if($detalle['id'] == 812) { ?>
			            		<input type="hidden" name="medidas" value="230x230">
			            		<input type="hidden" name="id_imagen_tipo" value="13">
			            	<?php } elseif($detalle['id'] == 791) { ?>
			            		<input type="hidden" name="medidas" value="1440x364">
			            		<input type="hidden" name="medidas2" value="270x205">
...
<!-- Fin Modal Ingresar Info Prototipos -->
	   		...
	   		<div class="modal-content animated">
		        ...
		        <div class="modal-body p-xs pull-left full-width">
			        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/ingresar_informacion/'); ?>">
	                    ...
	                    <div class="col-sm-6">
		                    <label class="control-label pull-left">Provincia</label>
                            <?php echo form_dropdown('texto_adicional', $provincias, null, 'class="form-control m-b"'); ?>
		                </div>
	                    <?php } else { ?>
	                    ...
	                    <?php if($detalle['id'] == 791) { ?>
	                    <div class="col-sm-12 m-b-sm">
		                    <label class="control-label pull-left">Miniatura</label>
                            <div class="fileinput fileinput-new input-group p-xs form-control" data-provides="fileinput">
	                    ...
	                    <?php } if($detalle['id'] == 794) { ?>
	                    <div class="col-sm-12 m-b-sm">
		                    <label class="control-label pull-left">Archivo</label>
                            <div class="fileinput fileinput-new input-group p-xs form-control" data-provides="fileinput">
...
<!-- Fin Modal Ingresar Informacion -->

<!-- Modal Ingresar Miembros -->
    <div class="modal inmodal" id="myModalIngresarMiembros" tabindex="-1" role="dialog" aria-hidden="true">
	    <div class="modal-dialog modal-lg">
	   		<div class="modal-content animated">
		        <div class="modal-header">
		            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Cerrar</span></button>
		            <h4 class="modal-title">Ingresar contenido de Miembros</h4>
		        </div>
			        ...
			        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/ingresar_informacion/'); ?>">
	                   ...
	                   <div class="col-sm-12 m-b-sm">
	                    ...
	                    <div class="col-sm-12 m-b-sm">
	                    	...
	                    	<small class="font-italic">Recomendado 1440 x 500 píxeles. Recuerde que el peso debe ser el mínimo posible para no afectar la descarga del site.</small>
	                    </div>
	                    ...
	                    <div class="col-sm-12 m-t-sm">
			            	...
			            	<input type="hidden" name="idioma" id="idioma" value="">
			            	<input type="hidden" name="medidas" value="1440x500">
			            	<input type="hidden" name="id_contenido" id="id_contenido" value="">
			                <input type="submit" class="btn btn-primary pull-right" value="Ingresar">
	                    </div>
		            </form>
...
<script>
  ...
  $('#myModalIngresarInformacion2').on('show.bs.modal', function(e) {    
     var id = $(e.relatedTarget).data().id;
     var seccion = $(e.relatedTarget).data().seccion;
     var id_contenido = $(e.relatedTarget).data().id_contenido;
     var contenido = $(e.relatedTarget).data().contenido;
