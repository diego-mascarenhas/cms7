                        ...
                        <div class="tab-content">
                        	...
                        	<?php 
								if(!empty($detalle['id']))
								{
									...
									$archivo = $this->Paginas_model->getArchivo($detalle['id'], $idioma['extension']);
								}
							?>
					                 	...
					                 	<div class="form-group">
											...
											<div class="col-sm-5">
		                                        <div class="input-group">
													<input type="text" name="titulo_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['titulo'])) ? $item['titulo'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título de la sección, que se mostrará antes del contenido."> <i class="fa fa-question"></i></button>
			                                    </div>
											</div>
											...
											<div class="col-sm-5">
		                                        <div class="input-group">
													<input type="text" name="subtitulo_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['subtitulo'])) ? $item['subtitulo'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Subtítulo de la sección, en caso de requerir."> <i class="fa fa-question"></i></button>
			                                    </div>
											</div>
										</div>
										
					                 	<div class="form-group pull-left m-t-sm">
											<label class="col-sm-1 control-label">Galería de Imágenes</label>
											<div class="col-sm-5">
						                    ...
						                    <div class="col-sm-5">
					                            ...
					                            <div class="col-sm-12">
		                                        	<div class="input-group">
						                            	<input type="file" name="archivo_<?php echo $idioma['extension'];?>" class="form-control"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Archivo en PDF."> <i class="fa fa-question"></i></button>
						                            </div>
					                            </div>
											</div>
					                ...
					                <div class="col-lg-12 p-xxs">
					                 	<div class="form-group">
											...
											<div class="form-group m-b-md pull-left full-width m-t-md">
							                    <div class="col-sm-12">
													<div class="ibox-title bg-muted m-t-md"><h5>Contenido</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Texto de la sección."> <i class="fa fa-question"></i></button></div>
