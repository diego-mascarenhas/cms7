					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Contenido General</h2>
					                 	<div class="form-group">
											...
											<div class="col-sm-5">
		                                        <div class="input-group">
													<input type="text" name="url_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['url'])) ? $item['url'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Código del video."> <i class="fa fa-question"></i></button>
			                                    </div>
											</div>
					                 	</div>

					                 	<div class="form-group pull-left m-t-sm">
										    <!-- Imagenes Generales -->
					                 	...
					                 	<div class="form-group pull-left m-t-sm">
											...
											<div class="col-sm-5">
		                                        <div class="input-group">
													<input type="text" name="subtitulo_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['subtitulo'])) ? $item['subtitulo'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Subtítulo de la sección, que se mostrará sobre la imagen del encabezado, debajo del título."> <i class="fa fa-question"></i></button>
			                                    </div>
											</div>
										</div>
										...
										<div class="form-group m-b-md pull-left full-width m-t-md">
						                    <div class="col-md-12 col-lg-6">
												<div class="ibox-title bg-muted"><h5>Box de Texto</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Contenido de la sección."> <i class="fa fa-question"></i></button></div>
												<div class="ibox-content no-padding">
											...
											<label class="col-sm-2 control-label text-right">Galería de Imágenes</label>
											<div class="col-sm-4">
					                            <?php echo form_dropdown('texto_adicional_'.$idioma['extension'], $media_proyectos, $item['texto_adicional'], 'class="form-control m-b"'); ?>
											</div>
										</div>
										...
										<div class="form-group m-b-md pull-left full-width m-t-md">
						                    <div class="col-sm-12 p-xxs m-t-md">
							                    <div class="pull-left full-width">
								                	<h3 class="bg-muted p-xs pull-left full-width">Listado de ventajas<a title="Ordenar" href="<?php echo base_url('cms-v2/paginas/ordenar/'.$detalle['id'].'/593/'.$idioma['extension']);?>" class="sepV_a btn btn-primary btn-sm red pull-right m-l-sm"><i class="fa fa-sort-circle"></i> Ordenar</a> 
													...
													<label class="col-sm-1 control-label m-t-md">Título</label>
													<div class="col-sm-5 m-t-md">
				                                        <div class="input-group">
															<input type="text" name="contenido6_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['contenido6'])) ? $item['contenido6'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título de ventajas."> <i class="fa fa-question"></i></button></span>
					                                    </div>
													</div>
							                    </div>
							                    
							                    <div class="pull-left full-width m-t-md">
								                <?php 
													$parametros1['id'] = $detalle['id'];
													$parametros1['id_tipo'] = 593;
													$parametros1['idioma'] = $idioma['extension'];
													$ventajas= $CI->Paginas_model->getContenidoAdicionalIdioma($parametros1);
	
									                if(!empty($ventajas)) {
													foreach($ventajas as $ventaja) { ?>	
									                <div class="col-md-6 col-lg-3 box-items">
														<div class="contact-box<?php echo ($ventaja['estado'] == 1) ? ' bg-inactiva' : ''; ?>">
										                    <div class="col-sm-12">
										                        <div class="text-center">
										                            <?php if($ventaja['imagen']) { ?>
										                            	<img src="<?php echo base_url('multimedia/thumbs/'.$ventaja['imagen']);?>" title="<?php echo $ventaja['titulo']; ?>" alt="<?php echo $ventaja['titulo'];?>" class="m-b-xs">
										                            <?php } ?>
										                        </div>
										                    </div>
										                    <div class="col-sm-12">
										                        <h3><strong><?php echo ellipsize($ventaja['titulo'],25, 1);?></strong></h3>
										                        <p><i class="fa fa-calendar"></i> Subida: <?php echo $ventaja['fecha_alta'];?></p>
										                        <address>
										                            <div><?php echo character_limiter($ventaja['contenido1'], 58, '...');?></div>
										                        </address>
										                    </div>
										                    <div class="col-sm-12">
						                                            <a title="Modificar" href="<?php echo base_url('cms-v2/paginas/modificar_informacion/'.$detalle['id'].'/'.$ventaja['id']);?>" class="btn btn-sm btn-danger"><i class="fa fa-minus-circle"></i> Modificar</a>
						                                            <a title="Eliminar" id="item" href="#" data-toggle="modal" data-seccion="<?php echo $ventaja['titulo'];?>?" data-estado="<?php echo $ventaja['estado'];?>" data-id_contenido="<?php echo $detalle['id'];?>" data-id="<?php echo $ventaja['id'];?>" data-target="#myModalEliminarInformacion" class="btn btn-sm btn-danger"><i class="fa fa-minus-circle"></i> Eliminar</a>
										                    </div>
										                </div>
										             </div>
										...
										<div class="form-group m-b-md pull-left full-width m-t-md">
						                    <div class="col-sm-12 p-xxs m-t-md">
							                    <div class="pull-left full-width">
								                	<h3 class="bg-muted p-xs pull-left full-width">Listado de ítems<a title="Ordenar" href="<?php echo base_url('cms-v2/paginas/ordenar/'.$detalle['id'].'/861/'.$idioma['extension']);?>" class="sepV_a btn btn-primary btn-sm red pull-right m-l-sm"><i class="fa fa-sort-circle"></i> Ordenar</a> 
								                	<a title="Ingresar" id="item" href="#" data-toggle="modal" data-seccion="<?php echo $detalle['seccion']; ?>" data-id_contenido="<?php echo $detalle['id'];?>" data-idioma="<?php echo $idioma['extension'];?>" data-target="#myModalIngresarInformacion" class="sepV_a btn btn-primary btn-sm red pull-right"><i class="fa fa-plus-circle"></i> Ingresar</a></h3>
													<label class="col-sm-1 control-label m-t-md">Título</label>
													<div class="col-sm-5 m-t-md">
				                                        <div class="input-group">
															<input type="text" name="contenido5_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['contenido5'])) ? $item['contenido5'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título de ítems."> <i class="fa fa-question"></i></button></span>
					                                    </div>
													</div>
							                    </div>
								                ...
								                <?php 
													...
													$parametros['id_tipo'] = 861;
													$parametros['idioma'] = $idioma['extension'];
													$ventajas= $CI->Paginas_model->getContenidoAdicionalIdioma($parametros);
										...
										<div class="form-group m-b-md pull-left full-width m-t-md">
						                    <div class="col-md-12 col-lg-6">
												<div class="ibox-title bg-muted m-t-md"><h5>Box de Texto</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Contenido de la sección."> <i class="fa fa-question"></i></button></div>
												<div class="ibox-content no-padding">
										...
										<div class="form-group m-b-md pull-left full-width m-t-md">
						                    <div class="col-sm-12 m-t-md m-b-md">
							                	<h3 class="bg-muted p-xs pull-left full-width">Steel Alliance</h3>
						                    </div>
						                    <div class="col-md-12 col-lg-6">
												<div class="ibox-title bg-muted"><h5>Intro</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Introducción de fondo marrón."> <i class="fa fa-question"></i></button></div>
												<div class="ibox-content no-padding"><textarea class="form-control summernote" name="contenido7_<?php echo $idioma['extension'];?>" rows="3"><?php echo(isset($item['contenido7'])) ? $item['contenido7']: null?></textarea></div>
						                    </div>
