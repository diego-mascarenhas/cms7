...
.contact-box { min-height: 200px;max-height: 300px; padding:20px 10px;display: flex;flex-direction: column;justify-content: center;}
	                            ...
	                            <div class="panel-body">
								 <div class="row">
					                <div class="col-lg-12 p-xxs">
										<?php if($detalle['id_con_secciones'] == 557) { ?>
										...
										<div class="form-group m-b-md pull-left full-width m-t-md">
					                 	...
					                 	<div class="form-group pull-left m-t-sm">
											<label class="col-sm-1 control-label">Título ventajas</label>
											<div class="col-sm-5">
		                                        <div class="input-group">
													<input type="text" name="contenido3_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['contenido3'])) ? $item['contenido3'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título de ventajas."> <i class="fa fa-question"></i></button>
			                                    </div>
											</div>
										</div>
										<?php } else { ?>
										...
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Encabezado</h2>
					                 	<div class="form-group">
											...
											<div class="col-sm-5">
		                                        <div class="input-group">
													<input type="text" name="titulo_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['titulo'])) ? $item['titulo'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título de la sección, que se mostrará sobre la imagen del encabezado."> <i class="fa fa-question"></i></button>
			                                    </div>
											</div>
					                 	...
					                 	<div class="form-group pull-left m-t-sm">
						                    ...
						                    <div class="col-sm-5">
					                            <?php if(!empty($imagen)) { ?>
					                            <div class="col-sm-12">
					                            	<img src="/multimedia/thumbs/<?php echo $imagen['imagen_breadcrumb'];?>" style="height:auto;width:auto; max-width:300px;float: left;padding-bottom: 24px;padding-right: 25px;"/>
					                            </div>
				                            	<?php } ?>
					                            <div class="col-sm-12">
		                                        	<div class="input-group">
											...
											<?php if($detalle['id_con_secciones'] == 560) { ?>
						                    ...
						                    <div class="col-sm-5">
					                            ...
					                            <div class="col-sm-12">
		                                        	<div class="input-group">
						                            	<input type="file" name="imagen_seccion_<?php echo $idioma['extension'];?>" class="form-control"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Mapa con fábricas."> <i class="fa fa-question"></i></button>
						                            </div>
					                            </div>
											</div>
				                            <?php } ?>
					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Contenido General</h2>
					                 	<div class="form-group">
											<label class="col-sm-1 control-label m-t-md">T&iacute;tulo</label>
											<div class="col-sm-5  m-t-md">
		                                        <div class="input-group">
													<input type="text" name="texto_adicional_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['texto_adicional'])) ? $item['texto_adicional'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título de la sección, que se mostrará antes del contenido."> <i class="fa fa-question"></i></button>
			                                    </div>
			                                  </div>
							                    <div class="col-sm-6  m-t-md">
													<div class="ibox-title bg-muted"><h5>Contenido</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Contenido de la sección."> <i class="fa fa-question"></i></button></div>
													<div class="ibox-content no-padding">
													    <textarea class="form-control summernote" name="contenido1_<?php echo $idioma['extension'];?>" rows="3"><?php echo(isset($item['contenido1'])) ? $item['contenido1']: null?></textarea></div>
							                    </div>
			                               </div>
				                    ...
				                    <?php } }?>	
				                  <?php if($detalle['id_con_secciones'] != 560) { echo ' </div>'; } ?>
