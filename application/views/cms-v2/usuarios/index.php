     ...
     <link href="<?php echo base_url('assets/css/plugins/dataTables/datatables.min.css'); ?>" rel="stylesheet" type="text/css">
           <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-xs-4 col-sm-4 col-lg-4" style="margin-top:34px; text-align:right;">
                    <a href="<?php echo base_url('cms-v2/usuarios/ingresar/'); ?>" class="btn btn-primary">Ingresar</a>
                </div>
            </div>
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
		                   ...
		                   <?php foreach($listado as $lista) { ?>	
		                        ...
		                        <td><?php echo ($lista['area_privada'] == 5) ? 'Comprador' : 'Administrador';?></td>
		                        <td><?php echo $lista['estado_original'];?></td>
		                        <td>
			                        <a href="<?php echo base_url('cms-v2/usuarios/ingresar/').$lista['id']; ?>" title="Modificar" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Editar</a> 
			                        <a title="Eliminar" id="item" href="#" data-toggle="modal" data-seccion='<?php echo $lista['nombre'].' '.$lista['apellido'];?>' data-id="<?php echo $lista['id'];?>" data-target="#myModal" class="sepV_a btn btn-primary btn-sm"><i class="fa fa-minus-circle"></i> Eliminar</a></td>
		                    </tr>
		                   <?php } ?>	
                    ...
                    <div class="modal inmodal" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="modal-content animated">
                            ...
                            <div class="modal-footer">
	                            <form name="eliminar" method="post" action="<?php echo base_url('cms-v2/usuarios/eliminar/'); ?>">
