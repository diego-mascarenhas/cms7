...
<link href="<?php echo base_url('assets/css/plugins/dataTables/datatables.min.css'); ?>" rel="stylesheet" type="text/css">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-8 col-sm-8 col-xs-8">
                <h2>Sitio web Ventas</h2>
                <ol class="breadcrumb">
                    <li>
                        <a href="/cms-v2">Home</a>
                    </li>
                    <li>
                        <a href="/cms-v2/ventas">Ventas</a>
                    </li>
                    <li class="active">
            ...
            <div class="row">
                <div class="col-lg-12">
	                <div class="ibox float-e-margins">
                    	<div class="ibox-title"><h5>Listado de Ventas</h5></div>
	                    <div class="ibox-content">
	                        <div class="table-responsive">
			                   ...
			                   <?php foreach($listado as $lista) { ?>	
			                   	 <tr class="gradeX">
			                        <td><?php echo $lista['pedido'];?></td>
			                        <td><?php echo $lista['fecha_alta'];?></td>
			                        <td><?php echo $lista['usuario'];?></td>
			                        <td><?php echo $lista['monto'];?></td>
			                        <td><?php echo $lista['estado'];?></td>
			                        <td>
				                        <a href="<?php echo base_url('cms-v2/compras/ingresar/').$lista['id']; ?>" title="Modificar" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Editar</a> 
				                        <a href="<?php echo base_url('cms-v2/compras/eliminar/').$lista['id']; ?>" title="Duplicar" class="btn btn-primary btn-sm"><i class="fa fa-copy"></i> Eliminar</a></td>
			                    </tr>
			                   <?php } ?>	
