								 ...
								 <div class="row">
					                ...
					                <div class="col-lg-12 p-xxs">
										<div class="form-group m-b-md pull-left full-width m-t-md">
						                    ...
						                    <label class="text-right col-sm-1 control-label">Profesores</label>
											<div class="col-sm-3">
		                                        <div class="input-group">
			                                        <?php echo form_multiselect('profesores_'.$idioma['extension'].'[]', $profesores, null, array('class'=>'form-control m-b')); ?>
		                                        	<span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Profesores del curso." title=""> <i class="fa fa-question"></i></button></span>
		                                        </div>
											</div>
				                 		</div>
					                </div>
					                ...
					                <div class="col-lg-12 p-xxs">
										<div class="form-group m-b-md pull-left full-width m-t-md">
				                            ...
				                            <div class="col-sm-3">
					                            <div class="radio radio-inline"><input type="radio" name="estado_<?php echo $idioma['extension'];?>" value="3" <?php if (isset($item['estado']) && $item['estado'] == '3') echo 'checked="checked"'; ?>> <label> Activo </label></div>
					                            <div class="radio radio-inline"><input type="radio" name="estado_<?php echo $idioma['extension'];?>" value="1" <?php if (isset($item['estado']) && $item['estado'] == '1') echo 'checked="checked"'; ?>><label> Inactivo </label></div>
					                ...
					                <div class="col-lg-12 p-xxs">
										...
										<div class="form-group m-b-md pull-left full-width m-t-md">
											...
											<div class="col-sm-4">
		                                        <div class="input-group">
		                                        	<input type="text" name="video_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['video'])) ? $item['video']: null; ?>"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Código de video." title=""> <i class="fa fa-question"></i></button></span>
		                                        </div>
											</div>
