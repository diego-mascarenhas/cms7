                        ...
                        <div class="table-responsive">
		                   ...
		                   <?php 
		                   	...
		                   	?>	
		                        ...
		                        <td><?php echo ($lista['razon_social']) ? $lista['razon_social'] : '------';?></td>
		                        <td><?php echo $lista['estado'];?></td>
		                        <td>
			                        <a href="<?php echo base_url('cms-v2/elearning/usuarios/modificar/individuos/').$lista['id']; ?>" title="Modificar" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Modificar</a> 
									...
									<a title="Eliminar" href="#" data-toggle="modal" data-seccion='<?php echo $lista['contacto'];?>' data-id="<?php echo $lista['id'];?>" data-estado='<?php echo $lista['id_estado'];?>' data-target="#myModal" class="sepV_a btn btn-primary btn-sm"><i class="fa fa-minus-circle"></i> Eliminar</a>
								</td>
		                    </tr>
		                   <?php } } else { ?>	
		                   	 <tr class="gradeX">
                        ...
                        <div class="modal-content animated">
                            ...
                            <div class="modal-footer">
	                            <form name="eliminar" method="post" action="<?php echo base_url('cms-v2/elearning/usuarios/eliminar/'); ?>">
	                            	<input type="hidden" name="tipo" value="individuos">
