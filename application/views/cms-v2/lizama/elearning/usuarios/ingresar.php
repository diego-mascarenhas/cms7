...
.ibox-content, .form-group, .hr-line-dashed { float:left; width:100%; }
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-xs-8 col-sm-8 col-lg-8">
                <h2>Clientes <?php echo ($this->uri->segment(5) == 'individuos') ? 'Individuos' : 'Empresas';?></h2>
                <ol class="breadcrumb">
                    <li><a href="/micuenta">Home</a></li>
                    <li><a href="/cms-v2/elearning/usuarios/<?php echo ($this->uri->segment(5) == 'individuos') ? 'individuos' : 'empresas';?>">Usuarios</a></li>
                    <li class="active"><strong><?php echo (empty($item['id'])) ? 'Ingresar' : 'Modificar'; ?></strong></li>
                </ol>
            </div>
            ...
            <input type="hidden" name="tipo_contacto" value="<?php echo ($this->uri->segment(5) == 'individuos') ? 0 : 1;?>">
        </div>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
				...
				<div class="col-md-12">
					<?php if ($this->session->flashdata('resultado') == 'ok') { ?>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
	                    <h5><?php echo (!isset($item['id'])) ? 'Ingresar usuario' : 'Modificar usuario'; ?></h5>
                    </div>
                    ...
                    <div class="col-sm-12">
	                 	...
	                 	<div class="form-group" style="float-left; width:100%;">
		                    <?php if ($this->uri->segment(5) == 'individuos') { ?>
		                    ...
		                    <div class="col-sm-3"><input type="text" name="empresa" class="form-control" value="<?php echo (isset($item['razon_social'])) ? $item['razon_social']: null; ?>"></div>
		                    <?php } else { ?>
		                    <label class="col-sm-1 control-label">Empresa*</label>
		                    <div class="col-sm-3"><input type="text" name="empresa" class="form-control" value="<?php echo (isset($item['razon_social'])) ? $item['razon_social']: null; ?>"></div>
	                 	...
	                 	<div class="form-group">
		                    ...
		                    <div class="col-sm-3"><input type="text" name="domicilio_entrega" class="form-control" value="<?php echo (isset($item['domicilio_entrega'])) ? $item['domicilio_entrega']: ''; ?>"></div>
	                 	</div>							
