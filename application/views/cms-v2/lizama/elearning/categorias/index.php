...
<link href="<?php echo base_url('assets/css/plugins/dataTables/datatables.min.css'); ?>" rel="stylesheet" type="text/css">
         ...
         <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-xs-4 col-sm-4 col-lg-4" style="margin-top:34px; text-align:right;">
                <a href="<?php echo base_url('cms-v2/elearning/categorias/ingresar'); ?>" class="btn btn-primary">Ingresar</a>
            </div>
        </div>
		                    ...
		                    <div class="ibox-content">
		                        <div class="table-responsive">
				                   ...
				                   <?php if($listado) { foreach($listado as $lista) { ?>	
				                        ...
				                        <td>
	 				                        <a href="<?php echo base_url('cms-v2/elearning/categorias/modificar/').$lista['id']; ?>" title="Modificar" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Modificar</a> 
<!-- 					                        <a href="<?php echo base_url('cms-v2/elearning/categorias/duplicar/').$lista['id']; ?>" title="Duplicar" class="btn btn-primary btn-sm"><i class="fa fa-copy"></i> Duplicar</a> -->
					                        <a href="<?php echo base_url('cms-v2/elearning/categorias/ordenar'); ?>" title="Ordenar" class="btn btn-primary btn-sm"><i class="fa fa-sort"></i> Ordenar</a>
        ...
        <div class="modal-content animated">
            ...
            <p>&iquest;Est&aacute; seguro de querer eliminar la categoría <strong> <input type="text" name="seccion" id="seccion" value="" style="border:1px solid #f8fafb; background:#f8fafb; width:auto !important;"/></strong>?</p>
                <div class="modal-footer">
	                <form name="eliminar" class="form_eliminar" method="post" action="<?php echo base_url('cms-v2/elearning/categorias/eliminar/'); ?>">
