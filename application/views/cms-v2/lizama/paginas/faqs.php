					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Encabezado</h2>
					                 	<div class="form-group">
											...
											<div class="col-sm-5">
		                                        <div class="input-group">
													<input type="text" name="subtitulo_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['subtitulo'])) ? $item['subtitulo'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Subtítulo de la sección, que se mostrará sólo en caso de ser necesario." title=""> <i class="fa fa-question"></i></button>
												</div>
											</div>
					                 	</div>
					                 	</div>
					                ...
					                <?php 
					                    ...
					                    <div class="col-sm-12 p-xxs">
						                    <div class="pull-left full-width">
							                	...
							                	<a title="Ingresar" id="item" href="#" data-toggle="modal" data-id="<?php echo $categoria['id']; ?>" data-id_contenido="<?php echo $detalle['id'];?>" data-idioma="<?php echo $idioma['extension'];?>" data-target="#myModalFaqs" class="sepV_a btn btn-primary btn-sm red pull-right"><i class="fa fa-plus-circle"></i> Ingresar</a></h3>
	    ...
	    <div class="modal-dialog modal-lg">
	   		<div class="modal-content animated">
		        <div class="modal-header">
		            ...
		            <h4 class="modal-title">Ingresar contenido de<br>Listado de preguntas</h4>
		        </div>
		        ...
		        <div class="modal-body p-xs pull-left full-width">
			        <form name="ingresar" class="form_ingresar" method="post" enctype="multipart/form-data" action="<?php echo base_url('cms-v2/paginas/ingresar_informacion/'); ?>">
	                   ...
	                   <div class="col-sm-12 m-b-sm">
		                    <label class="control-label pull-left">Pregunta</label>
		                    <input type="text" name="titulo" id="titulo" value="" class="form-control">
		                </div>
	                    <div class="col-sm-12 m-b-sm">
		                    <label class="control-label pull-left">Respuesta</label>
								<div class="ibox-content no-padding">
								    <textarea class="form-control summernote2" name="contenido1" rows="4"  value=""></textarea>
								</div>
						</div>
	                    <div class="col-sm-6">
	                    ...
	                    <div class="col-sm-12 m-t-sm">
			            	...
			            	<input type="hidden" name="idioma" id="idioma" value="<?php echo $idioma['extension'];?>">
