...
.box-items { padding-left:5px; padding-right:5px;}
       ...
       <div class="row wrapper border-bottom white-bg page-heading">
			...
			<?php
				...
				{
					case '271'; echo '<input type="hidden" name="medidas" value="300x240">';break;
					case '273'; echo '<input type="hidden" name="medidas" value="300x300">';break;
					default; echo '<input type="hidden" name="medidas" value="300x300">';break;
				}
			?>
										...
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Encabezado</h2>
					                 	<div class="form-group">
						                    ...
						                    <div class="col-sm-5">
					                            ...
					                            <div class="col-sm-12">
		                                        	<div class="input-group">
						                            	<input type="file" name="imagen_<?php echo $idioma['extension'];?>" class="form-control"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Imagen asociada a la sección, en caso de requerir." title=""> <i class="fa fa-question"></i></button>
						                            </div>
					                            </div>
											</div>
					                 	</div>
