...
.box-items { padding-left:5px; padding-right:5px;}
       ...
       <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <form action="/cms-v2/paginas/modificar/<?php echo $detalle['id']; ?>/" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				...
				<input type="hidden" name="medidas" value="1280x720">
					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Contenido general</h2>
					                 	<div class="form-group">
										    ...
										    <!-- Imagenes Generales -->
											<label class="col-sm-1 control-label">Imagen de fondo</label>
						                    <div class="col-sm-5">
					                            <?php if(!empty($imagen)) { ?>
					                            <div class="col-sm-12">
					                            ...
					                            <div class="col-sm-12">
		                                        	<div class="input-group">
						                            	<input type="file" name="imagen_<?php echo $idioma['extension'];?>" class="form-control"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Imagen asociada a la sección, en caso de requerir, tamaño 1280x720." title=""> <i class="fa fa-question"></i></button></div>
					                            </div>
											</div>
					                 	</div>
