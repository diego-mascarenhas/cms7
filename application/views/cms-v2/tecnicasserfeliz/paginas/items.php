...
.inmodal .modal-header { padding: 12px 15px; }
.inmodal .modal-header h4 { font-size: 23px; line-height:32px; }
					                 	...
					                 	<div class="form-group pull-left">
											...
											<div class="col-sm-5">
		                                        <div class="input-group">
													<input type="text" name="titulo_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['titulo'])) ? $item['titulo'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título de la sección, que se mostrará sólo en caso de ser necesario sobre la imagen del encabezado." title=""> <i class="fa fa-question"></i></button>
												</div>
											</div>
								                ...
								                <div class="col-md-6 col-lg-3 box-items">
													<div class="contact-box<?php echo ($miembro['estado'] == 1) ? ' bg-inactiva' : '';?>">
									                    ...
									                    <div class="col-sm-12">
									                        ...
									                        <address>
									                            <div><?php echo strip_tags(character_limiter($miembro['contenido1'], 58, '...'));?></div>
									                        </address>
									                    </div>
