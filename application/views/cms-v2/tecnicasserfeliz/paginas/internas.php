					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Contenido General</h2>
					                 	<div class="form-group pull-left full-width">
											<?php if($detalle['id'] == 646) { ?>
						                    <div class="col-md-6">
												<div class="ibox-title m-t-xs no-borders"><h5>Contenido</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Contenido de la sección." title=""> <i class="fa fa-question"></i></button></div>
						                    ...
						                    <div class="col-md-6">
												<div class="form-group m-b-md pull-left full-width m-t-md">
				                            		...
				                            		<div class="col-md-8">
				                            			<img src="<?php echo base_url('/multimedia/thumbs/'.$imagen2['imagen']);?>" style="height:200px;width:auto;float: left;padding-bottom: 24px;padding-right: 25px;"/></div>
												</div>
											<?php } ?>
												<div class="form-group m-b-md pull-left full-width m-t-md">
									                ...
									                <div class="col-md-8">
				                                        <div class="input-group">
					                                       ...
					                                       <input type="hidden" name="medidas2" value="430x600">
							                            	<input type="file" name="imagen_seccion_<?php echo $idioma['extension'];?>" class="form-control"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Imagen del autor.Tamaño 430x600 píxeles." title=""> <i class="fa fa-question"></i></button>
					                                </div>
								                </div>
											</div>
											<?php } else { ?>
