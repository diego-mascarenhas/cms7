...
.tooltip-inner {max-width: 250px;width: 250px;}
       ...
       <div class="row wrapper border-bottom white-bg page-heading">
			...
			<input type="hidden" name="medidas" value="1600x168">
					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Contenido General</h2>
					                 	<div class="form-group pull-left">
											...
											<div class="col-sm-5">
		                                        <div class="input-group">
													<input type="text" name="contenido4_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['contenido4'])) ? $item['contenido4'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título de la sección, que se mostrará antes del contenido." title=""> <i class="fa fa-question"></i></button>
			                                    </div>
			                                  </div>
			                             </div>
					                 	<div class="form-group pull-left">
											<label class="col-sm-1 control-label">Código Video</label>
											<div class="col-sm-5">
		                                        <div class="input-group">
													<input type="text" name="contenido3_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['contenido3'])) ? $item['contenido3'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título de la sección, que se mostrará antes del conteniod." title=""> <i class="fa fa-question"></i></button>
			                                    </div>
			                                  </div>
						                    ...
						                    <div class="col-sm-5">
					                            ...
					                            <div class="col-sm-12">
		                                        	<div class="input-group">
						                            	<input type="file" name="imagen_seccion_<?php echo $idioma['extension'];?>" class="form-control"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Imagen asociada a la sección, en caso de requerir. El tamaño depende de la misma: 530x400 para Autor." title=""> <i class="fa fa-question"></i></button>
						                            </div>
					                            </div>
											</div>
											...
											<div class="form-group m-b-md pull-left full-width m-t-md">
							                    <div class="col-sm-6">
													<div class="ibox-title bg-muted m-t-md"><h5>Texto Inicial</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Contenido de la sección." title=""> <i class="fa fa-question"></i></button></div>
							                    ...
							                    <div class="col-sm-6">
													<div class="ibox-title bg-muted m-t-md"><h5>Texto Completo</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Contenido de la sección." title=""> <i class="fa fa-question"></i></button></div>
													<div class="ibox-content no-padding">
