                ...
                <div class="col-lg-12">
                	<div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h5>Ordenar imágenes del curso <a href="/cms-v2/cursos/ingresar/<?php echo $item['id'];?>"><?php echo $item['titulo'];?></a></h5>
	                    </div>
                	</div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            update: function( event, ui ) {
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url('cms-v2/cursos/ordenarMedia/media'); ?>',
