...
.p_b_25 { padding-bottom:25px !important;}
	     ...
	     <div class="row wrapper border-bottom white-bg page-heading">
	        <div class="col-xs-8 col-sm-8 col-lg-8">
	            ...
	            <ol class="breadcrumb">
	                ...
	                <li class="active">
	                    <strong>Relacionar charlas</strong>
	                </li>
	            </ol>
	        </div>
        ...
        <div class="wrapper wrapper-content animated fadeInRight p_b_25">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox-title ibox-title-custom"><h5>Relacionar charla</h5></div>
                </div>
            ...
            <div class="row" style="margin:0px !important">
				...
				<div class="col-lg-12 float-e-margins" style="background:#fff;">
                    <div class="ibox-title" style="border:none !important;">
                		<h5>Relacionar cursos seleccionados del listado a la charla: <em><?php echo isset($item['titulo']) ? $item['titulo'] :  null; ?></em> <button type="button" class="btn btn-info btn-circle" data-toggle="tooltip" data-placement="right" title="Los cursos seleccionados del listado se mostrarán en el sidebar de la charla"><i class="fa fa-question"></i></button></h5></div>
