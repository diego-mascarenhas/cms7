                ...
                <div class="col-lg-12">
                	<div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h5>Ordenar imágenes de <a href="/cms-v2/contenidos/ingresar/<?php echo $item['id_contenido'];?>" style="text-transform:capitalize;"><?php echo $item['titulo'];?></a></h5>
	                    </div>
                	</div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            update: function( event, ui ) {
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url('cms-v2/contenidos/ordenarMedia/media'); ?>',
