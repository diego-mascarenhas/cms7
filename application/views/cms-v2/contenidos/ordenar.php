        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-xs-8 col-sm-8 col-lg-8">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>Ordenar contenidos de la sección </strong>
                    </li>
                </ol>
            </div>
...
<!--                         <img src="<?php echo base_url('/multimedia/511/7358/'.$lista['imagen']); ?>" style="width:120px;"> -->
                        <?php echo $lista['titulo'];?> - <?php echo $lista['orden'];?></li>
		                <?php } ?>	
                    </ul>
                </div>	
                <div class="col-lg-1"></div>
    ...
    <script>
        $(document).ready(function(){
            ...
            update: function( event, ui ) {
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url('cms-v2/contenidos/ordenarContenidos'); ?>',
