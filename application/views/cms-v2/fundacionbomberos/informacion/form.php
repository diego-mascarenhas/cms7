...
.tooltip-inner {
      ...
      width: 250px;
         ...
         <div class="row wrapper border-bottom white-bg page-heading">
			...
			<input type="hidden" name="medidas_miniatura_imagen2" value="400x250">
								 ...
								 <div class="row">
					                ...
					                <div class="col-lg-12 p-xxs">
										<div class="form-group m-b-md pull-left full-width m-t-md">
											...
											<div class="col-sm-5">
		                                        <div class="input-group">
		                                    <input type="text" name="texto_adicional_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['texto_adicional'])) ? $item['texto_adicional']: null; ?>"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Nombre de la persona que firma la noticia, campo opcional." title=""> <i class="fa fa-question"></i></button></span>
		                                        </div>
											</div>
										</div>
					                </div>
					                ...
					                <div class="col-lg-12 p-xxs">
										<div class="form-group m-b-md pull-left full-width m-t-md">
				                            ...
				                            <div class="col-sm-3">
					                            ...
					                            <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Determina si el contenido se mostrará entre las tres primeras destacadas del Home. Si hay más de 3 destacadas se mostrarán las últimas cargadas." title=""> <i class="fa fa-question"></i></button>
					                         </div>
								 ...
								 <div class="row">
					                ...
					                <div class="col-lg-6 p-xxs">
										...
										<?php } ?>
							                ...
							                <div class="col-sm-8">
		                                        <div class="input-group">
			                                       <input type="file" name="imagen2_<?php echo $idioma['extension'];?>" class="form-control"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Debe tener 800x370 píxeles o proporcionales. Obligatoria, de esta imagen se generan las miniaturas de destacados del home, miniaturas de listado y la imagen detalle de la nota. Extensión .jpg, .png o .gif." title=""> <i class="fa fa-question"></i></button>
			                                    </div>
							                </div>
										</div>
									</div>
					                ...
					                <div class="col-lg-12 p-xxs">
										<div class="form-group m-b-md pull-left full-width m-t-md">
											<div class="col-lg-12 p-xxs">
												<div class="ibox-title bg-muted"><h5>Contenido</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Cuerpo de la noticia. Si no se redacta en el siguiente campo, se recomienda pegar el texto sin formato y aplicarle el formato deseado en cada caso." title=""> <i class="fa fa-question"></i></button></div>
