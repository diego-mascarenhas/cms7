										...
										<td>
											<div class="dropdown">
											  ...
											  <ul class="dropdown-menu dropdown-clientes" aria-labelledby="dropdownMenu1">
											    <li><a href="<?php echo base_url('cms-v2/informacion/modificar/' . $lista['id']); ?>" title="Modificar" class="btn btn-sm"><i class="fa fa-pencil"></i> Modificar</a></li>
											    <li><a href="<?php echo base_url('cms-v2/informacion/duplicar/' . $lista['id']); ?>" title="Duplicar" class="btn btn-sm"><i class="fa fa-copy"></i> Duplicar</a></li>
											    <li><a href="<?php echo base_url('cms-v2/informacion/ordenar/' . $lista['id_con_secciones']); ?>" title="Ver contactos" class="btn btn-sm"><i class="fa fa-sort"></i> Ordenar</a></li>
											    <li><a title="Eliminar" id="item" href="#" data-toggle="modal" data-seccion="<?php echo $lista['titulo'];?>" data-estado="<?php echo $lista['id_estado'];?>" data-id="<?php echo $lista['id'];?>" data-target="#myModalEliminarInformacion" class="sepV_a btn btn-sm"><i class="fa fa-minus-circle"></i> Eliminar</a></li> 
											  </ul>
											</div>
										</td>
				                    </tr>
