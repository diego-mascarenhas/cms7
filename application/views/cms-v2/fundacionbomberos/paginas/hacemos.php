					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Contenido</h2>
					                 	<div class="form-group m-b-md pull-left full-width">
											<div class="col-sm-12">
												<div class="ibox-title bg-muted m-t-md"><h5>Texto</h5><button type="button" class="btn btn-primary m-l-sm btn-circle btn-sm" data-toggle="tooltip" data-placement="top" data-original-title="Texto de contenido." title=""> <i class="fa fa-question"></i></button></div>
					                ...
					                <?php 
					                    ...
					                    <div class="col-sm-12 p-xxs">
						                    <div class="pull-left full-width">
							                	...
							                	<a title="Ingresar" id="item" href="#" data-toggle="modal" data-seccion="<?php echo $categoria['id']; ?>" data-id_contenido="<?php echo $detalle['id'];?>" data-idioma="<?php echo $idioma['extension'];?>" data-target="#myModalIngresar" class="sepV_a btn btn-primary btn-sm red pull-right"><i class="fa fa-plus-circle"></i> Ingresar ítem</a></h2>
											<div class="col-sm-12 m-t-md">
												<label class="col-sm-1 control-label">Título</label>
												<div class="col-sm-5"><input type="text" name="subtitulo_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['subtitulo'])) ? $item['subtitulo']: null; ?>"></div>
												<label class="col-sm-1 control-label">Subtítulo</label>
												<div class="col-sm-5"><input type="text" name="texto_adicional_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['texto_adicional'])) ? $item['texto_adicional']: null; ?>"></div>
											</div>
