	                 	...
	                 	<div class="form-group">
		                    <div class="col-md-4 sm-12 m_b_25">
			                    ...
			                    <div class="ibox-content no-padding">
				                    <textarea class="form-control summernote" name="descripcion" rows="7"><?php echo (isset($item['descripcion'])) ? $item['descripcion']: null?></textarea>
			                    </div>
		                    </div>
		                    <div class="col-md-4 sm-12 m_b_25">
			                    ...
			                    <div class="ibox-content no-padding">
				                    <textarea class="form-control summernote" name="keywords" rows="7"><?php echo (isset($item['keywords'])) ? $item['keywords']: null?></textarea>
			                    </div>
		                    </div>
		                    <div class="col-md-4 sm-12 m_b_25">
		                    	<div class="ibox-title" style="background:#F5EFEF;"><h5>Analytics</h5></div>
			                    <div class="ibox-content no-padding">
				                    <textarea class="form-control summernote" name="analytics" rows="7"><?php echo (isset($item['analytics'])) ? $item['analytics']: null?></textarea>
			                    </div>
		                    </div>
	                 	</div>
					 	<div class="hr-line-dashed"></div>
