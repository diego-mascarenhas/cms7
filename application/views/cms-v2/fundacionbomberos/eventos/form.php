								 ...
								 <div class="row">
					                <div class="col-lg-12 p-xxs">
										<div class="form-group m-b-md pull-left full-width m-t-md">
											...
											<div class="col-md-3">
												<?php echo (isset($detalle['filtro1'])) ? form_dropdown('filtro1', $cursos, $detalle['filtro1'], array('class'=>'form-control m-b')) : form_dropdown('filtro1', $cursos, null, array('class'=>'form-control m-b')); ?>
											</div>
						                    <label class="text-right col-md-1 control-label">Empresa</label>
											<div class="col-md-3">
												<?php echo (isset($detalle['filtro2'])) ? form_dropdown('filtro2', $empresas, $detalle['filtro2'], array('class'=>'form-control m-b')) : form_dropdown('filtro2', $empresas, null, array('class'=>'form-control m-b')); ?>
											</div>
				                 		</div>
					                </div>
