...
.box-items { padding-left:5px; padding-right:5px;}
       ...
       <div class="row wrapper border-bottom white-bg page-heading">
			...
			<?php
				...
				{
					case '117'; echo '<input type="hidden" name="medidas" value="300x100">';break;
					case '120'; echo '<input type="hidden" name="medidas" value="120x120">';break;
					case '129'; echo '<input type="hidden" name="medidas" value="560x400">';break;
					case '132'; echo '<input type="hidden" name="medidas" value="180x40">';break;
					case '135'; echo '<input type="hidden" name="medidas" value="580x400">';break;
					default; echo '<input type="hidden" name="medidas" value="500x500">';break;
				}
			?>
										...
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Encabezado</h2>
					                 	<div class="form-group">
						                    ...
						                    <div class="col-sm-5">
					                            <?php if(!empty($imagen)) { ?>
					                            <div class="col-sm-12">
					                            	<img src="<?php echo base_url('multimedia/thumbs/'.$imagen['imagen_breadcrumb']);?>" style="height:auto;width:100%;max-width:300px;float: left;padding-bottom: 24px;padding-right: 25px;"/>
					                            </div>
				                            	<?php } ?>
					                            <div class="col-sm-12">
		                                        	<div class="input-group">
						                            	<input type="file" name="imagen_<?php echo $idioma['extension'];?>" class="form-control"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Imagen asociada a la sección, en caso de requerir. El tamaño depende de la misma: 580x400 para Inicio, 200x100 en Quiénes Somos, 560x400 para Contacto, 120x120 para servicios y 500x500 por default." title=""> <i class="fa fa-question"></i></button>
						                            </div>
					                            </div>
											</div>
					                 	</div>

					                 	<?php if($detalle['id_con_secciones'] == 123) { ?>
										<div class="form-group m-b-md pull-left full-width m-t-md">
						                    <div class="col-sm-6">
												<div class="ibox-title bg-muted m-t-md"><h5>Texto Proyectos</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Contenido de la sección." title=""> <i class="fa fa-question"></i></button></div>
						                    ...
						                    <div class="col-sm-6">
												<div class="ibox-title bg-muted m-t-md"><h5>Texto Equipo</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Contenido de la sección." title=""> <i class="fa fa-question"></i></button></div>
												<div class="ibox-content no-padding">
