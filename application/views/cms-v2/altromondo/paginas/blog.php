...
.contact-box { min-height: 300px;max-height: 300px; padding:20px 10px;}
}
*/

/*
@media(min-width:1400px) {
.contact-box { min-height: 300px;max-height: 300px; }
}
*/
</style>
					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Encabezado</h2>
					                 	<div class="form-group">
						                    ...
						                    <div class="col-sm-6">
												<div class="ibox-title bg-muted"><h5>Contenido</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título y subtítulo de la sección." title=""> <i class="fa fa-question"></i></button></div>
