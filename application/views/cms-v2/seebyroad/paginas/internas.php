...
.box-items { padding-left:5px; padding-right:5px;}
       ...
       <div class="row wrapper border-bottom white-bg page-heading">
			...
			<input type="hidden" name="medidas" value="1540x230">
					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Encabezado</h2>
					                 	<div class="form-group">
											<label class="col-sm-2 col-md-1 control-label">T&iacute;tulo</label>
											<div class="col-sm-10 col-md-5 m-b-md">
											...
											<label class="col-sm-2 col-md-1 control-label">Subt&iacute;tulo</label>
					                 	...
					                 	<div class="form-group pull-left m-t-sm">
										    <!-- Imagenes Generales -->
											<label class="col-sm-2 col-md-1 control-label">Imagen</label>
											<div class="col-sm-10 col-md-5">
					                            <?php if(!empty($imagen)) { ?>
					                            <div class="col-sm-12">
							                ...
							                <?php 
								                ...
								                <div class="col-md-6 col-lg-3 box-items">
													<div class="contact-box<?php echo ($miembro['estado'] == 1) ? ' bg-inactiva' : '';?>">
									                    ...
									                    <div class="col-sm-12 pull-right text-right" style="padding:0;">
				                                            ...
				                                            <a title="Eliminar" id="item" href="#" data-toggle="modal" data-seccion="<?php echo $miembro['titulo'];?>?" data-estado="<?php echo $miembro['estado'];?>" data-id_contenido="<?php echo $detalle['id'];?>" data-id="<?php echo $miembro['id'];?>" data-target="#myModalEliminarInformacion" class="btn btn-sm btn-danger"><i class="fa fa-minus-circle"></i> Eliminar</a><br>
				                                            <?php if($detalle['id'] != 565) { ?>
				                                            <a title="Relacionar" href="<?php echo base_url('cms-v2/paginas/relacionar_informacion/'.$miembro['id']);?>" class="btn btn-sm btn-danger m-t-sm"><i class="fa fa-car"></i> Relacionar destinos</a>
				                                            <a title="Relacionar" href="<?php echo base_url('cms-v2/paginas/relacionar_informacion/'.$miembro['id']);?>" class="btn btn-sm btn-danger m-t-sm"><i class="fa fa-link"></i> Relacionar paquetes</a>
				                                            <?php }  ?>
									                    </div>
									                </div>
									             </div>
