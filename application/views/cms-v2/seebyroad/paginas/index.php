						...
						{							
							...
							<?php foreach($menu1 as $obj): ?>
								...
								<?php } ?>
			                    		...
			                    		<?php } ?>
			                    		<?php if ($obj['url'] != null) { ?><a href="<?php echo base_url('cms-v2/paginas/modificar/'.$obj['id_contenido']); ?>" title="Modificar p&aacute;gina" class="btn btn-primary btn-sm pull-right"><i class="fa fa-pencil"></i> Modificar</a> <?php } ?>
			                        </p>
			                    	<?php } else { ?>
