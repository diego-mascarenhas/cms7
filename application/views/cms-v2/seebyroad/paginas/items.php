								 ...
								 <div class="row">
					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Encabezado</h2>
					                 	<div class="form-group">
											...
											<div class="col-sm-12 col-md-5 m-b-md">
										    ...
										    <!-- Imagenes Generales -->
											<label class="col-sm-12 col-md-5 control-label">Imagen</label>
						                    <div class="col-sm-12 col-md-5">
					                            ...
					                            <div class="col-sm-12">
		                                        	<div class="input-group">
						                            	<input type="file" name="imagen_<?php echo $idioma['extension'];?>" class="form-control"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Imagen asociada al encabezado la sección. Medida: 1540x230 píxeles." title=""> <i class="fa fa-question"></i></button>
						                            </div>
					                            </div>
											</div>
					                 	</div>
					                ...
					                <div class="col-lg-12 p-xxs">
										<h2 class="b-r-sm bg-muted p-xs pull-left full-width">Contenido General</h2>
											...
											<label class="col-sm-1 control-label">T&iacute;tulo</label>
											<div class="col-sm-11 col-md-5 m-b-md">
		                                        <div class="input-group">
													<input type="text" name="texto_adicional_<?php echo $idioma['extension'];?>" class="form-control" value="<?php echo (isset($item['texto_adicional'])) ? $item['texto_adicional'] : null; ?>"> <span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título del contenido, previo al listado de ítems."> <i class="fa fa-question"></i></button>
			                                    </div>
			                                  </div>

							                    <div class="col-sm-12 col-md-6">
													<div class="ibox-title bg-muted"><h5>Contenido</h5> <button type="button" class="btn btn-primary btn-circle m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Introducción de la sección, previo al listado de ítems."> <i class="fa fa-question"></i></button></div>
