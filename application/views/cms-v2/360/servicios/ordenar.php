                ...
                <div class="col-lg-12">
                	<div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h5>Ordenar items de <a href="<?php echo base_url('cms-v2/servicios/modificar-categoria/'.$this->uri->segment(4));?>" title="Ir a la sección <?php echo $item['categoria'];?>"><?php echo $item['categoria'];?></a> en idioma 
	                        <?php 
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    <ul class="sortable-list connectList agile-list" id="media">
                        ...
                        <li class="lista" id="<?php echo $lista['id_servicio']; ?>">
...
<script>
    $(document).ready(function(){
        ...
        update: function( event, ui ) {
			...
			$.ajax({
				type: 'POST',
				url: '<?php echo base_url('cms-v2/servicios/ordenarInformacion/media'); ?>',
