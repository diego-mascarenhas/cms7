...
.tooltip-inner {max-width: 250px;width: 250px;}
       ...
       <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-xs-8 col-sm-8 col-lg-8">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo base_url('cms-v2/servicios/');?>">Proyectos</a>
                    </li>
                    <li class="active">
	   ...
	   <?php if ($item['id_tipo'] == 717) { echo '<input type="hidden" name="medidas" value="280x280">'; }  else { echo '<input type="hidden" name="medidas" value="1300x620">';} ?>	   
        <div class="wrapper wrapper-content animated fadeInRight">
	        <div class="row">
	            <div class="col-lg-12">
	                <div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h5>Modificar contenido de <?php echo ($item['id_tipo'] == 714) ? 'Planta' : 'Logo de Empresa'; ?> de proyecto <a href="/cms-v2/servicios/modificar/<?php echo $detalle['id'];?>"><?php echo $detalle['titulo'];?></a></h5>
	                    </div>
	                    <div class="ibox-content">
							...
							<?php if ($item['id_tipo'] == 714) { ?>
                            <div class="form-group">
			                    <label class="text-right col-sm-2 control-label">Titulo</label>
			                    <div class="col-sm-3 col-md-3">
                                    <div class="input-group">
                                    	<input type="text" name="titulo" class="form-control" value="<?php echo (isset($item['titulo'])) ? $item['titulo']: null; ?>"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Nombre de la planta, por ej. 'Planta Baja'." title=""> <i class="fa fa-question"></i></button></span>
                                    </div>
			                    </div>
                            </div>
                            ...
                            <div class="form-group">
			                    ...
			                    <div class="col-sm-3 col-md-3">
                                    <div class="input-group">
                                    	<input type="text" name="titulo" class="form-control" value="<?php echo (isset($item['titulo'])) ? $item['titulo']: null; ?>"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Nombre de la empresa, obligatorio." title=""> <i class="fa fa-question"></i></button></span>
                                    </div>
			                    </div>
                            </div>
                            <div class="hr-line-dashed"></div>
