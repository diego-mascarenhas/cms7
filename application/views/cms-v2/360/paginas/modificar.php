...
.tooltip-inner {max-width: 250px;width: 250px;}
	   ...
	   <?php if ($detalle['id_con_secciones'] == 699) { echo '<input type="hidden" name="medidas" value="280x280">'; }  elseif($detalle['id_con_secciones'] == 702) { echo '<input type="hidden" name="medidas" value="1300x620">'; } else { echo '<input type="hidden" name="medidas" value="2000x1000">'; } ?>	   
	            ...
	            <div class="col-lg-12">
	                ...
	                <div class="ibox float-e-margins">
	                    ...
	                    <div class="ibox-content">
							...
							<?php if ($detalle['id_con_secciones'] == 702) { ?>
                            ...
                            <div class="form-group">
			                    <label class="text-right col-sm-2 control-label">Texto <button type="button" class="btn btn-primary btn-circle btn-sm" data-toggle="tooltip" data-placement="top" data-original-title="Texto del ítem." title=""> <i class="fa fa-question"></i></button></label>

			                    <div class="col-sm-4 col-md-8"><textarea class="form-control summernote2" name="contenido1" rows="4"><?php echo (isset($item['contenido1'])) ? $item['contenido1']: null; ?></textarea></div>
		                    </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
								...
								<?php if((isset($item['titulo'])) && $item['imagen']) { ?>
                            		...
                            		<div class="col-sm-4"><img src="<?php echo base_url('/multimedia/thumbs/'.$item['imagen']);?>" style="height:auto;width:250px;float: left;padding-bottom: 24px;padding-right: 25px;"/></div>
                            		<label class="text-right col-sm-1 control-label">Imagen</label>
					                <div class="col-sm-3">
                                        <div class="input-group">
	                                       <input type="file" name="imagen" class="form-control"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Imagen en jpg, gif o png de 1300x620 píxeles. Recuerde que el peso debe ser el mínimo posible para no afectar la descarga del site." title=""> <i class="fa fa-question"></i></button>
	                                    </div>
					                </div>
									<?php } else { ?>
							...
							<?php } elseif ($detalle['id_con_secciones'] == 699) { ?>
                            <div class="form-group">
			                    <label class="text-right col-sm-2 control-label">Titulo</label>
			                    <div class="col-sm-3 col-md-3">
                                    <div class="input-group">
			                    ...
			                    <div class="col-sm-3 col-md-3">
									<div class="input-group"><?php echo form_dropdown('media_proyecto', $media_proyectos, $item['id_proyecto'], 'class="form-control m-b-md"'); ?><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-sm" data-toggle="tooltip" data-placement="top" data-original-title="Galería asociada al servicio, previamente cargada desde Multimedia." title=""> <i class="fa fa-question"></i></button></span></div>
								</div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
								...
								<?php if((isset($item['titulo'])) && $item['imagen']) { ?>
					                ...
					                <div class="col-sm-3">
                                        <div class="input-group">
	                                       <input type="file" name="imagen" class="form-control"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Imagen en jpg, gif o png de 280x280 píxeles. Recuerde que el peso debe ser el mínimo posible para no afectar la descarga del site." title=""> <i class="fa fa-question"></i></button>
	                                    </div>
					                </div>
									<?php } else { ?>
                            		<label class="text-right col-sm-3 control-label">Imagen</label>
                            ...
                            <div class="form-group">
			                    ...
			                    <div class="col-sm-3 col-md-3">
                                    <div class="input-group">
                                    	<input type="text" name="titulo" class="form-control" value="<?php echo (isset($item['titulo'])) ? $item['titulo']: null; ?>"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Título que se mostrará sobre la imagen con recuadro blanco. Debe ser una palabra breve." title=""> <i class="fa fa-question"></i></button></span>
                                    </div>
			                    </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            ...
                            <div class="form-group">
								...
								<?php if((isset($item['titulo'])) && $item['imagen']) { ?>
					                ...
					                <div class="col-sm-3">
                                        <div class="input-group">
	                                       <input type="file" name="imagen" class="form-control"><span class="input-group-btn"><button type="button" class="btn btn-primary m-l-md" data-toggle="tooltip" data-placement="top" data-original-title="Imagen en jpg, gif o png de 2000x1000 píxeles. Recuerde que el peso debe ser el mínimo posible para no afectar la descarga del site." title=""> <i class="fa fa-question"></i></button>
	                                    </div>
					                </div>
									<?php } else { ?>
                            		<label class="text-right col-sm-3 control-label">Imagen</label>
