			...
			<div class="row wrapper border-bottom white-bg page-heading">
	            ...
	            <div class="col-xs-4 col-sm-4 col-md-6 col-lg-6">
                    <div class="title-action">
                        <a href="<?php echo base_url('tienda/cupones/ingresar'); ?>" class="btn btn-primary btn-sm">Ingresar Cup&oacute;n</a>
                    </div>
                </div>
	        </div>
	                    ...
	                    <div class="ibox-content">
	                        <div class="table-responsive">
			                   ...
			                   <?php foreach($listado as $lista) { ?>	
			                        ...
			                        <td class="bg-<?php if($lista['cantidad'] == 0) { echo 'danger'; } else { echo 'verde'; } ?>"><?php echo $lista['cantidad']; ?></td>
			                        <td class="bg-<?php if($lista['estado'] == 1) { echo 'danger'; } else { echo 'verde'; } ?>"><?php echo $lista['tipo_estado'];?> </td>
			                        <td>
				                        <a href="<?php echo base_url('tienda/cupones/modificar/').$lista['id']; ?>" title="Modificar" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Modificar</a> 
										<a title="Eliminar" id="item" href="#" data-toggle="modal" data-seccion='<?php echo $lista['cupon'];?>' data-id="<?php echo $lista['id'];?>" data-estado='<?php echo $lista['estado'];?>' data-target="#myModal" class="sepV_a btn btn-primary btn-sm"><i class="fa fa-minus-circle"></i> Eliminar</a>
			                    </tr>
			                   <?php } ?>	
        ...
        <div class="modal-content animated">
            ...
            <div class="modal-body">
	            ...
	            <div class="modal-footer">
	                <form name="eliminar" method="post" action="<?php echo base_url('tienda/cupones/eliminar'); ?>">
