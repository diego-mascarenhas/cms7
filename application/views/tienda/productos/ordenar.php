                ...
                <div class="col-lg-12">
                	<div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h5>Ordenar productos de la categoría <a href="<?php echo base_url('tienda/categorias/modificar/'.$categoria['id']); ?>"><?php echo $categoria['categoria'];?> </a></h5>
	                    </div>
                	</div>
                </div>
            </div>
                ...
                <div class="col-lg-10">
                    <ul class="sortable-list connectList agile-list" id="media">
                        ...
                        <li class="lista" id="<?php echo $lista['id']; ?>">
	                        <img src="<?php echo ($lista['imagen']) ? base_url('/multimedia/513/tienda/'.$lista['imagen']) : 'https://app.pedimosfacil.com/v2/assets/images/no-disponible.jpg';?>" title="" alt="" class="listados_miniatura">
                        <?php echo $lista['titulo'];?></li>
		                <?php } ?>	
                    </ul>
                </div>	
                <div class="col-lg-1"></div>
    ...
    <script>
        $(document).ready(function(){
            ...
            update: function( event, ui ) {
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url('tienda/productos/ordenarProductos/media'); ?>',
