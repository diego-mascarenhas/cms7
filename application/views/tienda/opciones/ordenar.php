			...
			<div class="row wrapper border-bottom white-bg page-heading">
            	<div class="col-xs-8 col-sm-8 col-md-6 col-lg-6">
	                ...
	                <ol class="breadcrumb">
	                    ...
	                    <li>
	                        <a href="<?php echo base_url('tienda/opciones'); ?>">Grupos de Opciones</a>
	                    </li>
	                    <li>
                ...
                <div class="col-lg-12">
                	<div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h5>Ordenar Grupos de Opciones</h5>
	                    </div>
                	</div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-10">
                    <ul class="sortable-list connectList agile-list" id="media">
                        ...
                        <?php echo $lista['opcion_grupo'];?></li>
		                <?php } ?>	
                    </ul>
                </div>	
                <div class="col-lg-1"></div>
    ...
    <script>
        $(document).ready(function(){
            ...
            update: function( event, ui ) {
				...
				$.ajax({
					type: 'POST',
					url: '<?php echo base_url('tienda/opciones/ordenarOpciones/media'); ?>',
