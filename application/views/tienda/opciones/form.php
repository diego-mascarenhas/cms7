	            ...
	            <div class="col-lg-12">
	                <div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h5><?php echo (isset($item['id'])) ? 'Modificar' : 'Crear nuevo'; ?> Grupo de Opci&oacute;n</h5>
	                    </div>
	                    ...
	                    <div class="ibox-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
	                                <input type="text" class="form-control" name="opcion_grupo" value="<?php if (isset($item['opcion_grupo'])) { echo $item['opcion_grupo']; } else { if ($this->input->post('opcion_grupo')) { echo $this->input->post('opcion_grupo'); } }?>">
	                            </div>
	                            <label class="col-sm-2 control-label">Cantidad</label>
                                <div class="col-sm-4">
	                                <input type="text" class="form-control" name="cantidad" value="<?php if (isset($item['cantidad'])) { echo $item['cantidad']; } else { if ($this->input->post('cantidad')) { echo $this->input->post('cantidad'); } }?>">
	                            </div>
                            </div>
