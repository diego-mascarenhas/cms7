<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
			...
			<div class="wrapper wrapper-content animated fadeInRight">
				<div class="alert alert-info">
					<a href="<?php echo base_url('administracion/facturas/detalle/'); ?><?php echo $factura['id']; ?>">ID: <?php echo $factura['id']; ?></a>
					<?php echo '<pre>' . print_r($factura, true) . '</pre>'; ?>
				</div>
	            <div class="row">
	                <div class="col-lg-12">
	                                ...
	                                <table class="table table-striped footable">
	                                    ...
	                                    <tbody>
		                                    ...
		                                    <tr>
		                                        ...
		                                        <td><?php echo $factura['cae_numero']; ?><br>
		                                        	<small><?php echo $factura['cae_vencimiento']; ?></small>
		                                        </td>
		                                        <td class="text-right">
