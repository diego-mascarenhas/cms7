<?php defined('BASEPATH') OR exit('No direct script access allowed'); ?>
	            ...
	            <div class="col-xs-4 col-sm-4 col-md-6 col-lg-6">
                    ...
                    <div class="title-action">
                        <a href="<?php echo ($this->usuario->perfil == 'reseller') ? base_url('administracion/contactos/?order_by=nombre&order=ASC') : 'https://revisionalpha.com'; ?>" target="_blank" class="btn btn-primary btn-sm"><?php echo $this->lang->line('cms_users-crear-ticket'); ?></a>
                    </div>
                </div>
		        </div>				
