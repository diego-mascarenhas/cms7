		                            ...
		                            <?php echo form_open(null, array('class'=>'form-horizontal')); ?>
			                            ...
			                            <div class="col-sm-12 text-center">
				                                ...
				                                <?php if ($this->session->has_userdata('referrer')) { ?>
												 <!-- type="submit"														 -->
												<a class="btn btn-white"  href="<?php echo $this->session->userdata('referrer'); ?>">Cancelar
												</a><?php } ?>
			                                    <button class="btn btn-primary" >Guardar cambios</button>

												<button type="button" name="button" class="btn btn-primary" style="margin-right: 25px;">
												<a href="<?php echo base_url('micuenta'); ?>" <?php echo $this->lang->line('cms_users-mi-cuenta'); ?> >
