				...
				else
				{
					...
					{					
				        foreach($idiomas as $idioma)
				        {
					        ...
					        if(!empty($_FILES['imagen2_'.$extension]['name']))
					        {
								$original = $this->upload($id, $_FILES['imagen2_'.$extension]['name'], 'imagen2_'.$extension, $extension, null, $this->input->post('medidas_imagen2'), $this->input->post('medidas_miniatura_imagen2')); 
							}
