        ...
        function a(a, b, c) {
            ...
            this.widgetState = null, this.animationControl = null, this.container = null, this.reInitWidget = function(a) {
                ...
                if (null !== d.params.parentWrapperId && void 0 !== d.params.parentWrapperId) {
                    ...
                    if (null !== b && b.hasOwnProperty("width") && b.hasOwnProperty("height"))
                        return void ParentWindowHelper.resize(d.params.parentWrapperId, b.width, b.height);
                ...
                if (!d.animationControl.isRunAnimation()) {
                    var b = a[0];
                    if (!b)
                        return void (d.slider.isSingleMode() ? d.goState(StateMashine.WIDGET_STATE_BUTTON_ACTION, d.slider.getOrderButtons()[0]) : d.goState(StateMashine.WIDGET_STATE_SLIDER));
            ...
            this.runningAnimates = [], this.onUpdateAnimates = function(b) {
                for (var c = b[0], d = 0; d < a.runningAnimates.length; d++)
                    if (a.runningAnimates[d].isEqual(c))
                        return void (c.status === Animates.ANIMATE_STATUS_CLOSE && a.runningAnimates.splice(d));
...
var WidgetSendButtonContainer = function() {
        ...
        this.container = null, this.onPostMessage = function(a) {
            if (a.origin.replace(/^https?:\/\//, "") === "widget." + c.params.host)
                try {
                    ...
                    if (null === b || !b.hasOwnProperty("name"))
                        return;
    ...
    return a.prototype.reInitWidget = function(a) {
        ...
        b.id = a.getIframeId(this.params.wrapperId), b.setAttribute("src", this.getWidgetUrl());
