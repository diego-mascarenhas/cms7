...
<tr>
	<td>
		<h2 style="font-size:30px; color:#FF6666; border-bottom:1px solid lightgrey;">Datos de Perfil Incompletos</h2>
		<br><br>
	</td>
</tr>
<tr>
	<td>		
		...
		<br>
		Para ingresar a su perfil de usuario y completar o modificar sus datos puede hacerlo desde el <a href="<?php echo 'https://cms.revisionalpha.com/user/login/?username=' . $_POST['username'] . '&password=' . $_POST['hash'] . '&redirect=https://cms.revisionalpha.com/micuenta/perfil/'; ?>" style="color:#FF6666;">&aacute;rea de clientes</a> de nuestro sitio.<br>
		<br>
		Una vez completados los datos podr&aacute; reactivarlos inmediatamente desde la <a href="<?php echo 'https://cms.revisionalpha.com/user/login/?username=' . $_POST['username'] . '&password=' . $_POST['hash'] . '&redirect=https://cms.revisionalpha.com/micuenta/servicios/'; ?>" style="color:#FF6666;">secci&oacute;n de servicios.</a>
	</td>
</tr>
