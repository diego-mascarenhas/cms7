...
<tr>
	<td>
		<h2 style="font-size:30px; color:#FF6666; border-bottom:1px solid lightgrey;">Tareas</h2>
		<br><br>
	</td>
</tr>
<tr>
	<td>
		<?php if ($_POST['tareas']) { ?>
			<?php foreach ($_POST['tareas'] as $item) { ?>
				<a href="<?php echo 'https://cms.revisionalpha.com/user/login/?username=' . $_POST['username'] . '&password=' . $_POST['hash'] . '&redirect=https://cms.revisionalpha.com/tareas/detalle/' . $item['id']; ?>" style="color:#FF6666;">
			...
			<?php } ?>
		<?php } else { ?>
			No posée tareas en curso, por favor <a href="<?php echo 'https://cms.revisionalpha.com/user/login/?username=' . $_POST['username'] . '&password=' . $_POST['hash'] . '&redirect=https://cms.revisionalpha.com/tareas?id_contacto=' . $_POST['id_contacto']; ?>" style="color:#FF6666;">
