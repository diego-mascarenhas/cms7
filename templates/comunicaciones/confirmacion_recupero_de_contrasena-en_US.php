...
<tr>
	<td>
		<h2 style="font-size:30px; color:#FF6666; border-bottom:1px solid lightgrey;">Password recovery confirmation</h2>
		<br><br>
	</td>
</tr>
<tr>
	<td>		
		...
		<br><br>
		<a href="https://cms.revisionalpha.com/user/password-reset-confirm/<?php echo $_POST['token']; ?>" style="color:#FF6666;">Confirm password recovery request</a>
		<br>
		<br>
