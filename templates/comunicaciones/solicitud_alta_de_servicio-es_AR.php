...
<tr>
	<td>
		<h2 style="font-size:30px; color:#FF1A1D; border-bottom:1px solid lightgrey;">Solicitud de Alta de Servicio</h2>
		<br><br>
	</td>
</tr>
<tr>
	<td>		
		...
		<br>
		<br>
		<a href="<?php echo 'https://cms.revisionalpha.com/user/login/?username=' . $_POST['username'] . '&password=' . $_POST['hash'] . '&redirect=https://cms.revisionalpha.com/micuenta/servicios/activar/' . $_POST['id']; ?>" style="color:#FF1A1D;">Confirmar solicitud de alta de plan</a>
		<br>
		<br>
