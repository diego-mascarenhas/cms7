            ...
            <div class="row">
                ...
                <div class="col-lg-6 principal">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="titulo">
                                <h1>Estamos tomando pedidos online</h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="qr-image">
                            <img src="<?php echo $_POST['base_url']; ?>tienda/qr/index/<?php echo $_POST['id']; ?>" alt="QR Pedimos Facil" title="Escaneá este código">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="url">
                                <a href="<?php echo $_POST['url'] . $_POST['titulo']; ?>" target="blank"><?php echo $_POST['url'] . $_POST['titulo']; ?></a>
                            </div>
                        </div>
                    </div>
                </div>
