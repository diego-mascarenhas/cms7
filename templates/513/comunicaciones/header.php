<html>
<head>
	<title>Pedimos Facil | Comunicaciones</title>
					...
					<tr>
						<td align="center">
							<table width="660" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
									<!-- cambio de imagen -->
									<td><h1><img src="https://cms.revisionalpha.com/templates/513/comunicaciones/images/logo-pedimos-facil.png" alt="pedimos facil logo" width="220" height="45" style="display:block; position:relative;"></h1></td>
									<td align="right">
										<?php
